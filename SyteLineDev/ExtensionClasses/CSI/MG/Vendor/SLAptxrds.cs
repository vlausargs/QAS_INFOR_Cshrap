...
{
    [IDOExtensionClass("SLAptxrds")]
    public class SLAptxrds : CSIExtensionClassBase
    {
        [IDOMethod(MethodFlags.None, "Infobar")]
        public int AptrxrgSp(byte? PAskFlag,
                             Guid? PRecidAptrx,
                             ref byte? RCheck1,
                             ...
                             ref string Infobar)
        {
            using (var MGAppDB = this.CreateAppDB())
            {
                ...
                var iAptrxrgExt = new AptrxrgFactory().Create(appDb);

                ListYesNoType oRCheck1 = RCheck1;
                GenericDecimalType oRSalesTax1 = RSalesTax1;
                ListYesNoType oRCheck2 = RCheck2;
                GenericDecimalType oRSalesTax2 = RSalesTax2;
                InfobarType oPromptMsg = PromptMsg;
                InfobarType oPromptButtons = PromptButtons;
                InfobarType oInfobar = Infobar;

                int Severity = iAptrxrgExt.AptrxrgSp(PAskFlag,
                                                     PRecidAptrx,
                                                     ref oRCheck1,
                                                     ref oRSalesTax1,
                                                     ref oRCheck2,
                ...
                RCheck1 = oRCheck1;
                RSalesTax1 = oRSalesTax1;
                RCheck2 = oRCheck2;
                RSalesTax2 = oRSalesTax2;
		...
		[IDOMethod(MethodFlags.None, "Infobar")]
		public int VendorGetRecurVoucherDistTtlSp(string TVendNum,
		int? TVoucher,
		...
		ref string Infobar)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iVendorGetRecurVoucherDistTtlExt = new VendorGetRecurVoucherDistTtlFactory().Create(appDb);
				
				var result = iVendorGetRecurVoucherDistTtlExt.VendorGetRecurVoucherDistTtlSp(TVendNum,
				TVoucher,
				TDistTotal,
				Infobar);
