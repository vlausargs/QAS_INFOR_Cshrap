...
{
	[IDOExtensionClass("SLVendLcrs")]
	public class SLVendLcrs : CSIExtensionClassBase
	{


		[IDOMethod(MethodFlags.None, "Infobar")]
		public int VendLcrRebalanceSp(string StartingVendNum,
		string EndingVendNum,
		string StartingLcrNum,
		string EndingLcrNum,
		ref int? VendLcrsRebalanced,
		ref string Infobar)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iVendLcrRebalanceExt = new VendLcrRebalanceFactory().Create(appDb);
				
				var result = iVendLcrRebalanceExt.VendLcrRebalanceSp(StartingVendNum,
				EndingVendNum,
				StartingLcrNum,
				EndingLcrNum,
				VendLcrsRebalanced,
				...
				VendLcrsRebalanced = result.VendLcrsRebalanced;
