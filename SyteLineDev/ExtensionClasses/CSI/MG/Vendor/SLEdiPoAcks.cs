...
{
	[IDOExtensionClass("SLEdiPoAcks")]
	public class SLEdiPoAcks : CSIExtensionClassBase
	{
		[IDOMethod(MethodFlags.None, "Infobar")]
		public int PoAckPostSp(Guid? PoackRowPointer,
		...
		ref string Infobar)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iPoAckPostExt = new PoAckPostFactory().Create(appDb);
				
				var result = iPoAckPostExt.PoAckPostSp(PoackRowPointer,
				VendTpRowPointer,
				Infobar);
