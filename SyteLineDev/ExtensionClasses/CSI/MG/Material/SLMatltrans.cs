...
{
    [IDOExtensionClass("SLMatltrans")]
    public class SLMatltrans : CSIExtensionClassBase
    {
		...
		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable Homepage_MetricCycleCountSp()
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				var appDb = new CSIAppDBFactory().CreateAppDB(MGAppDB, this.Context, this.GetMessageProvider());
				...
				var iHomepage_MetricCycleCountExt = new Homepage_MetricCycleCountFactory().Create(appDb, bunchedLoadCollection);
				
				var result = iHomepage_MetricCycleCountExt.Homepage_MetricCycleCountSp();
		...
		public DataTable MtCodeListSp()
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iMtCodeListExt = new MtCodeListFactory().Create(appDb,
				bunchedLoadCollection,
				mgInvoker,
				new CSI.Data.SQL.SQLParameterProvider(),
				true);
				
				var result = iMtCodeListExt.MtCodeListSp();
