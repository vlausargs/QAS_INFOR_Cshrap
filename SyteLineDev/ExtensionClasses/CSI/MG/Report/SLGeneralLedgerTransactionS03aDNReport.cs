//PROJECT NAME: MG
//CLASS NAME: SLGeneralLedgerTransactionS03aDNReport.cs
...
{
	[IDOExtensionClass("SLGeneralLedgerTransactionS03aDNReport")]
	public class SLGeneralLedgerTransactionS03aDNReport : CSIExtensionClassBase
	{
		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable Rpt_GeneralLedgerTransactionS03aDNReportSp([Optional] decimal? ExOptStartingTrans,
		...
		{
			var iRpt_GeneralLedgerTransactionS03aDNReportExt = new Rpt_GeneralLedgerTransactionS03aDNReportFactory().Create(this, true);
			
			var result = iRpt_GeneralLedgerTransactionS03aDNReportExt.Rpt_GeneralLedgerTransactionS03aDNReportSp(ExOptStartingTrans,
			ExOptEndingTrans,
			ExOptStartingRef,
			ExOptEndingRef,
			TAnalyticalLedger,
