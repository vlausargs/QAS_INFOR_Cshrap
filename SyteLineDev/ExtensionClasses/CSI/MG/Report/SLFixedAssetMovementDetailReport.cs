//PROJECT NAME: MG
//CLASS NAME: SLFixedAssetMovementDetailReport.cs
...
{
	[IDOExtensionClass("SLFixedAssetMovementDetailReport")]
	public class SLFixedAssetMovementDetailReport : CSIExtensionClassBase
	{
		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable Rpt_FAMovementDetailSp([Optional] DateTime? TransDateStarting,
		...
		[Optional] string pSite)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iRpt_FAMovementDetailExt = new Rpt_FAMovementDetailFactory().Create(appDb,
				bunchedLoadCollection,
				mgInvoker,
				new CSI.Data.SQL.SQLParameterProvider(),
				true);
				
				var result = iRpt_FAMovementDetailExt.Rpt_FAMovementDetailSp(TransDateStarting,
				TransDateEnding,
				ClassCodeStarting,
				ClassCodeEnding,
				ExOptdfFaType,
