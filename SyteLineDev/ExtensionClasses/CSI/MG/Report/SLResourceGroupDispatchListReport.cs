...
//CLASS NAME: SLResourceGroupDispatchListReport.cs
...
{
    [IDOExtensionClass("SLResourceGroupDispatchListReport")]
    public class SLResourceGroupDispatchListReport : ExtensionClassBase
    {

		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable Rpt_ResourceGroupDispatchListSp([Optional] string ResourceGroupType,
		...
		[Optional] string pSite)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iRpt_ResourceGroupDispatchListExt = new Rpt_ResourceGroupDispatchListFactory().Create(appDb,
				bunchedLoadCollection,
				mgInvoker,
				new CSI.Data.SQL.SQLParameterProvider(),
				true);
				
				var result = iRpt_ResourceGroupDispatchListExt.Rpt_ResourceGroupDispatchListSp(ResourceGroupType,
				ResourceStarting,
				ResourceEnding,
