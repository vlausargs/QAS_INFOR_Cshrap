...
//CLASS NAME: SLGeneralLedgerTransactionReport.cs
...
{
    [IDOExtensionClass("SLGeneralLedgerTransactionReport")]
    public class SLGeneralLedgerTransactionReport : CSIExtensionClassBase
    {
