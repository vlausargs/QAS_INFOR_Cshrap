...
{
	[IDOExtensionClass("SLSSDs")]
	public class SLSSDs : CSIExtensionClassBase
	{
		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable CLM_ECSupplimentaryStatisticalDeclarationSp(DateTime? PeriodStarting,
		                                                             ...
		                                                             [Optional] string pSite)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iCLM_ECSupplimentaryStatisticalDeclarationExt = new CLM_ECSupplimentaryStatisticalDeclarationFactory().Create(appDb, bunchedLoadCollection);
				
				var result = iCLM_ECSupplimentaryStatisticalDeclarationExt.CLM_ECSupplimentaryStatisticalDeclarationSp(PeriodStarting,
				                                                                                                       PeriodEnding,
				                                                                                                       ExOptdfEcSsdOpt,
