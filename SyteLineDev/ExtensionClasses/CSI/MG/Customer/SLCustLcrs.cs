...
{
	[IDOExtensionClass("SLCustLcrs")]
	public class SLCustLcrs : CSIExtensionClassBase
	{
		...
		public int RebalCustLcrSp(string BegCustNum,
		string EndCustNum,
		string BegLcrNum,
		string EndLcrNum,
		ref int? LcrCount)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iRebalCustLcrExt = new RebalCustLcrFactory().Create(appDb);
				
				var result = iRebalCustLcrExt.RebalCustLcrSp(BegCustNum,
				EndCustNum,
				BegLcrNum,
				EndLcrNum,
				LcrCount);
		...
		public DataTable Rpt_ShippedLCRsWithARemainingBalanceSp(string PCustomerStarting,
		...
		[Optional] string PSite)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iRpt_ShippedLCRsWithARemainingBalanceExt = new Rpt_ShippedLCRsWithARemainingBalanceFactory().Create(appDb,
				bunchedLoadCollection,
				mgInvoker,
				new CSI.Data.SQL.SQLParameterProvider(),
				true);
				
				var result = iRpt_ShippedLCRsWithARemainingBalanceExt.Rpt_ShippedLCRsWithARemainingBalanceSp(PCustomerStarting,
				PCustomerEnding,
				PLCRStarting,
				PLCREnding,
				PIssueDateStarting,
