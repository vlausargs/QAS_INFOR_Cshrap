...
{
    [IDOExtensionClass("SLCohs")]
    public class SLCohs : CSIExtensionClassBase
    {
		[IDOMethod(MethodFlags.None, "Infobar")]
		public int CohDelSp(string pStartingCONum,
		                    string pEndingCONum,
		                    DateTime? pStartingCODate,
		                    DateTime? pEndingCODate,
		                    string pStartingCustNum,
		                    string pEndingCustNum,
		                    ref int? rCOHsDeleted,
		                    ref string rInfobar,
		                    ...
		                    [Optional] short? EndingDateOffset)
		{
			using(var MGAppDB = this.CreateAppDB())
			{
				...
				var iCohDelExt = new CohDelFactory().Create(appDb);
				
				var result = iCohDelExt.CohDelSp(pStartingCONum,
				                                 pEndingCONum,
				                                 pStartingCODate,
				                                 pEndingCODate,
				                                 pStartingCustNum,
				...
				rCOHsDeleted = result.rCOHsDeleted;
		...
		public DataTable CLM_CoDomesticCurrencySp(string CurrCode,
		...
		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable CLM_EstDomesticCurrency(string CurrCode,
		[Optional, DefaultParameterValue(0)] int? UseBuyRate,
		[Optional] decimal? TRate,
		[Optional] DateTime? PossibleDate,
		[Optional] decimal? Amount1,
