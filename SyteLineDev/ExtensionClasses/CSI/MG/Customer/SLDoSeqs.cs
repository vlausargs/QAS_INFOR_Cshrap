...
{
    [IDOExtensionClass("SLDoSeqs")]
    public class SLDoSeqs : CSIExtensionClassBase
    {
                                         ...
                                         ref string Infobar)
        {
            using (var MGAppDB = this.CreateAppDB())
            {
                ...
                var iAddSingleByPOFilterExt = new AddSingleByPOFilterFactory().Create(appDb);

                int Severity = iAddSingleByPOFilterExt.AddSingleByPOFilterSp(PDoNum,
                                                                             ref PPOFilter,
                                                                             ref Infobar);
