...
{
	[IDOExtensionClass("SLDoLines")]
	public class SLDoLines : CSIExtensionClassBase
	{

		[IDOMethod(MethodFlags.CustomLoad, "Infobar")]
		public DataTable CLM_PopulateDoLineSp(string PDoNum)
		{
			var iCLM_PopulateDoLineExt = this.GetService<ICLM_PopulateDoLine>();

			var result = iCLM_PopulateDoLineExt.CLM_PopulateDoLineSp(PDoNum);
