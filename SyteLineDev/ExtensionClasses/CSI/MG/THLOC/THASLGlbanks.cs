...
{
    [IDOExtensionClass("THASLGlbanks")]
    public class THASLGlbanks : CSIExtensionClassBase
    {
                              ...
                              [Optional] int? ThruDateOffset)
        {
            using (var MGAppDB = this.CreateAppDB())
            {
                ...
                var iBankCompExt = new BankCompFactory().Create(appDb);
