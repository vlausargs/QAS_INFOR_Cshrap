//PROJECT NAME: Codes
//CLASS NAME: SaveVchProceduralMarkingsCRUD.cs
...
{
	public class SaveVchProceduralMarkingsCRUD : ISaveVchProceduralMarkingsCRUD
	{
		...
		public SaveVchProceduralMarkingsCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName: "optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('SaveVchProceduralMarkingsSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse Optional_Module1Select()
		{
			...
			{
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("SaveVchProceduralMarkingsSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
		...
		public (int? ReturnCode,
			string Infobar)
		AltExtGen_SaveVchProceduralMarkingsSp(
			string AltExtGenSp,
			string SiteRef,
			int? VchNum,
			int? VchSeq,
