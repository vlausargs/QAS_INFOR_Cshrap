...
//CLASS NAME: ExpectedReceiptsAPSItemChgCRUD.cs
...
{
	public class ExpectedReceiptsAPSItemChgCRUD : IExpectedReceiptsAPSItemChgCRUD
	{
		...
		public ExpectedReceiptsAPSItemChgCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName:"optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('ExpectedReceiptsAPSItemChgSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse Optional_Module1Select()
		{
			...
			foreach(var optional_module1Item in optional_module1LoadResponse.Items){
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("ExpectedReceiptsAPSItemChgSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
		...
		public bool ItemForExists(string Item)
		{
		...
		public (string Description, int? rowCount) Item1Load(string Item, string Description)
		{
		...
		public (int? ReturnCode,
			string Description)
		AltExtGen_ExpectedReceiptsAPSItemChgSp(
			string AltExtGenSp,
			string Item,
			string Description)
		{
