...
//CLASS NAME: CLM_ApsGetPARTCRUD.cs
...
{
    public class CLM_ApsGetPARTCRUD : ICLM_ApsGetPARTCRUD
    {
        ...
        public CLM_ApsGetPARTCRUD(IApplicationDB appDB,
        ...
        public bool Optional_ModuleForExists()
        {
            return existsChecker.Exists(tableName: "optional_module",
                ...
                whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_ApsGetPARTSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
        }
        ...
        public ICollectionLoadResponse Optional_Module1Select()
        {
            ...
            {
                optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_ApsGetPARTSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
            };
        ...
        {
            var optional_module1LoadResponse = Optional_Module1Select();
        ...
        public void DeclareDynamicParameterTable()
        {
            this.sQLExpressionExecutor.Execute(@"Declare
					...
					SELECT @SelectionClause AS SelectionClause,
					       ...
					       N'PARTID' AS KeyColumns,
					       @Filter AS FilterString
					INTO   #DynamicParameters
					WHERE 1 = 2");
        }
        public ICollectionLoadResponse DynamicparametersSelect(string SelectionClause, string FromClause, string WhereClause, string AdditionalClause, string Filter)
        {
        ...
        public void DynamicparametersInsert(string SelectionClause, string FromClause, string WhereClause, string AdditionalClause, string Filter)
        {
            var DynamicParametersLoadResponse = DynamicparametersSelect( SelectionClause,  FromClause,  WhereClause,  AdditionalClause,  Filter);
