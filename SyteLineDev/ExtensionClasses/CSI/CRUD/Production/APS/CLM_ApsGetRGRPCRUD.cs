...
//CLASS NAME: CLM_ApsGetRGRPCRUD.cs
...
{
	public class CLM_ApsGetRGRPCRUD : ICLM_ApsGetRGRPCRUD
	{
		...
		public CLM_ApsGetRGRPCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName:"optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_ApsGetRGRPSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse Optional_Module1Select()
		{
			...
			foreach(var optional_module1Item in optional_module1LoadResponse.Items){
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_ApsGetRGRPSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
			...
			var DynamicParametersLoadRequest = collectionLoadStatementRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
				{
					...
					{"AdditionalClause","N' ORDER BY RGID'"},
					{"KeyColumns","N'RGID'"},
