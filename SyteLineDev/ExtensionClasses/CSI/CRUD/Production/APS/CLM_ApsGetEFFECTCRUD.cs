...
//CLASS NAME: CLM_ApsGetEFFECTCRUD.cs
...
{
    public class CLM_ApsGetEFFECTCRUD : ICLM_ApsGetEFFECTCRUD
    {
        ...
        public CLM_ApsGetEFFECTCRUD(IApplicationDB appDB,
        ...
        public bool Optional_ModuleForExists()
        {
            return existsChecker.Exists(tableName: "optional_module",
                ...
                whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_ApsGetEFFECTSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
        }
        ...
        public ICollectionLoadResponse Optional_Module1Select()
        {
            ...
            {
                optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_ApsGetEFFECTSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
            };
        ...
        public void DeclareDynamicParameterTable()
        {
            this.sQLExpressionExecutor.Execute(@"Declare
					...
					SELECT @SelectionClause AS SelectionClause,
					       ...
					       N' ORDER BY EFFECTID' AS AdditionalClause,
					       N'EFFECTID' AS KeyColumns,
            ...
            var DynamicParametersLoadRequest = collectionLoadStatementRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
                {
                    ...
                    {"AdditionalClause","N' ORDER BY EFFECTID'"},
                    {"KeyColumns","N'EFFECTID'"},
        ...
        public void DynamicparametersInsert(string SelectionClause, string FromClause, string Filter)
        {
            var DynamicParametersLoadResponse = DynamicparametersSelect(SelectionClause, FromClause, Filter);
