...
//CLASS NAME: ICLM_ApsGetRGRPCRUD.cs
...
{
	public interface ICLM_ApsGetRGRPCRUD
	{
		...
		(ICollectionLoadResponse Data, int? ReturnCode) AltExtGen_CLM_ApsGetRGRPSp(string AltExtGenSp, int? AltNo, string Filter);
	}
}
