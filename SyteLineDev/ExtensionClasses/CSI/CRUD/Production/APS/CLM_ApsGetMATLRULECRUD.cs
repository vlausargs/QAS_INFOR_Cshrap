...
//CLASS NAME: CLM_ApsGetMATLRULECRUD.cs
...
{
    public class CLM_ApsGetMATLRULECRUD : ICLM_ApsGetMATLRULECRUD
    {
        ...
        public CLM_ApsGetMATLRULECRUD(IApplicationDB appDB,
        ...
        public bool Optional_ModuleForExists()
        {
            return existsChecker.Exists(tableName: "optional_module",
                ...
                whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_ApsGetMATLRULESp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
        }
        ...
        public ICollectionLoadResponse Optional_Module1Select()
        {
            ...
            {
                optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_ApsGetMATLRULESp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
            };
            ...
            var DynamicParametersLoadRequest = collectionLoadStatementRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
                {
                    ...
                    {"KeyColumns","N'LMATLID, RSITEID, EFFECTID'"},
        ...
        public (
            ...
            int? ReturnCode)
        AltExtGen_CLM_ApsGetMATLRULESp(
            string AltExtGenSp,
            int? AltNo,
            string Filter = null)
        {
