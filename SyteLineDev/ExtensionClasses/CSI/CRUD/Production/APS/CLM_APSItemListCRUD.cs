...
//CLASS NAME: CLM_APSItemListCRUD.cs
...
{
	public class CLM_APSItemListCRUD : ICLM_APSItemListCRUD
	{
		...
		public CLM_APSItemListCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName:"optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_APSItemListSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse Optional_Module1Select()
		{
			...
			foreach(var optional_module1Item in optional_module1LoadResponse.Items){
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_APSItemListSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
