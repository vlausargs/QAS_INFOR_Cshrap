...
//CLASS NAME: ICLM_ApsGetBOMCRUD.cs
...
{
    public interface ICLM_ApsGetBOMCRUD
    {
        ...
        (ICollectionLoadResponse Data, int? ReturnCode) AltExtGen_CLM_ApsGetBOMSp(string AltExtGenSp, int? AltNo, string Filter);
    }
}
