...
//CLASS NAME: CurrentMaterialsJobItemDataCRUD.cs
...
{
	public class CurrentMaterialsJobItemDataCRUD : ICurrentMaterialsJobItemDataCRUD
	{
		...
		public CurrentMaterialsJobItemDataCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName: "optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CurrentMaterialsJobItemDataSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse SelectOptional_ModuleForInsert()
		{
			...
			{
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CurrentMaterialsJobItemDataSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
		...
		public (int? ItemPlanFlag, int? rowCount) LoadItem(string Item, int? ItemPlanFlag)
		{
			Flag _ItemPlanFlag = DBNull.Value;
			...
			return (ItemPlanFlag, rowCount);
		}

		public (int? ReturnCode,
			int? ItemPlanFlag)
		AltExtGen_CurrentMaterialsJobItemDataSp(
			string AltExtGenSp,
			string Item,
			int? ItemPlanFlag)
		{
