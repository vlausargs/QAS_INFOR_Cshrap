...
//CLASS NAME: RSQC_GetUserCRUD.cs
...
{
    public class RSQC_GetUserCRUD : IRSQC_GetUserCRUD
    {
        ...
        public RSQC_GetUserCRUD(IApplicationDB appDB,
        ...
        public bool Optional_ModuleForExists()
        {
            return existsChecker.Exists(tableName:"optional_module",
                ...
                whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('RSQC_GetUserSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
        }
