...
//CLASS NAME: RSQC_CalcIntervalCRUD.cs
...
{
	public class RSQC_CalcIntervalCRUD : IRSQC_CalcIntervalCRUD
	{
		...
		public RSQC_CalcIntervalCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName: "optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('RSQC_CalcIntervalSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse SelectOptional_ModuleForInsert()
		{
			...
			{
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("RSQC_CalcIntervalSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				appDB.AddCommandParameter(cmd, "NewDate", _NewDate, ParameterDirection.InputOutput);
