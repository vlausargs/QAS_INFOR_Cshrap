...
//CLASS NAME: CLM_JobRouteOEECRUD.cs
...
{
	public class CLM_JobRouteOEECRUD : ICLM_JobRouteOEECRUD
	{
		...
		public CLM_JobRouteOEECRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName:"optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_JobRouteOEESp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse SelectOptional_ModuleForInsert()
		{
			...
			foreach(var optional_module1Item in optional_module1LoadResponse.Items){
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_JobRouteOEESp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
		...
		public ICollectionLoadResponse SelectOEE(string StrOEE, string StrWaste, decimal? JobRoutesOEE)
		{
		...
		public ICollectionLoadResponse SelectWaste(decimal? JobRoutesWASTE, string StrWaste)
		{
			...
			decimal? OEE)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				appDB.AddCommandParameter(cmd, "OEE", _OEE, ParameterDirection.Input);
