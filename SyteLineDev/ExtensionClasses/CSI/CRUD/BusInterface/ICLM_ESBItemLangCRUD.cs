...
//CLASS NAME: ICLM_ESBItemLangCRUD.cs
...
{
	public interface ICLM_ESBItemLangCRUD
	{
		...
		ICollectionLoadResponse SelectEsbitemlangview(string item);
		(ICollectionLoadResponse Data, int? ReturnCode) AltExtGen_CLM_ESBItemLangSp(string AltExtGenSp, string item);
	}
}
