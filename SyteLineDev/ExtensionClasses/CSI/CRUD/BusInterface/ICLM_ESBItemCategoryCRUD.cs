...
//CLASS NAME: ICLM_ESBItemCategoryCRUD.cs
...
{
	public interface ICLM_ESBItemCategoryCRUD
	{
		...
		ICollectionLoadResponse SelectEsbitemcategoryview(string item);
		(ICollectionLoadResponse Data, int? ReturnCode) AltExtGen_CLM_ESBItemCategorySp(string AltExtGenSp, string item);
	}
}
