...
//CLASS NAME: PredisplayApplicantsCRUD.cs
...
{
    public class PredisplayApplicantsCRUD : IPredisplayApplicantsCRUD
    {
        ...
        public PredisplayApplicantsCRUD(IApplicationDB appDB,
        ...
        public bool Optional_ModuleForExists()
        {
            return existsChecker.Exists(tableName: "optional_module",
                ...
                whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('PredisplayApplicantsSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
        }
        ...
        public ICollectionLoadResponse Optional_Module1Select()
        {
            ...
            {
                optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("PredisplayApplicantsSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
            };
        ...
        public ICollectionLoadResponse HrparmsSelect()
        {
            var hrparmsLoadRequestForScalarSubQuery = collectionLoadRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
                ...
                orderByClause: collectionLoadRequestFactory.Clause(""));
            return this.appDB.Load(hrparmsLoadRequestForScalarSubQuery);
        }

        public (int? ReturnCode,
            int? PCheckSsnEnabled)
        AltExtGen_PredisplayApplicantsSp(
            string AltExtGenSp,
            int? PCheckSsnEnabled)
        {
