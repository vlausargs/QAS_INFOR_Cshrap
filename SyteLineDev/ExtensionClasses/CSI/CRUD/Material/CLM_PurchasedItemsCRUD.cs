...
//CLASS NAME: CLM_PurchasedItemsCRUD.cs
...
{
	public class CLM_PurchasedItemsCRUD : ICLM_PurchasedItemsCRUD
	{
		...
		public CLM_PurchasedItemsCRUD(IApplicationDB appDB,
		...
		public bool Optional_ModuleForExists()
		{
			return existsChecker.Exists(tableName:"optional_module",
				...
				whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_PurchasedItemsSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL"));
		}
		...
		public ICollectionLoadResponse SelectOptional_ModuleForInsert()
		{
			...
			foreach(var optional_module1Item in optional_module1LoadResponse.Items){
				optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_PurchasedItemsSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
			};
		...
		public ICollectionLoadResponse SelectItem(string ItemFilter)
		{
			var itemLoadRequest = collectionLoadRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
				...
				tableName:"item",
				fromClause: collectionLoadRequestFactory.Clause(""),
				whereClause: collectionLoadRequestFactory.Clause("p_m_t_code = 'P' AND item LIKE '' + {0} + ''",ItemFilter),
				orderByClause: collectionLoadRequestFactory.Clause(" item"));
		...
		public (
			...
			int? ReturnCode)
		AltExtGen_CLM_PurchasedItemsSp(
			string AltExtGenSp,
