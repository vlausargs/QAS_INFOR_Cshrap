...
//CLASS NAME: INotifyPublicationSubscribers.cs
...
{
    public interface INotifyPublicationSubscribers
    {
        (int? ReturnCode, string Infobar) NotifyPublicationSubscribersSp(string PublicationName = null,
