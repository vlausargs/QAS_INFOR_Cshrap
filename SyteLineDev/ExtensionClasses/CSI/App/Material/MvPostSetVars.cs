...
{
	public interface IMvPostSetVars
	{
		(int? ReturnCode, decimal? PUnitCost, decimal? PMatlCost, decimal? PLbrCost, decimal? PFovhdCost, decimal? PVovhdCost, decimal? POutCost, decimal? PTotCost, string Infobar) MvPostSetVarsSp(string SET,
		string PType,
		DateTime? PDate,
		decimal? PQty,
		string PItem,
	...
	public class MvPostSetVars : IMvPostSetVars
	{
		readonly IApplicationDB appDB;
		
		public MvPostSetVars(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, decimal? PUnitCost, decimal? PMatlCost, decimal? PLbrCost, decimal? PFovhdCost, decimal? PVovhdCost, decimal? POutCost, decimal? PTotCost, string Infobar) MvPostSetVarsSp(string SET,
		string PType,
		DateTime? PDate,
		decimal? PQty,
		string PItem,
		...
		DateTime? FromSiteRecordDate = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "MvPostSetVarsSp";
