...
//CLASS NAME: MultiFSBCalcBalBuildRateFile.cs
...
{
	public class MultiFSBCalcBalBuildRateFile : IMultiFSBCalcBalBuildRateFile
	{
		readonly IApplicationDB appDB;
		
		public MultiFSBCalcBalBuildRateFile(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string PeriodName = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "MultiFSBCalcBalBuildRateFileSp";
