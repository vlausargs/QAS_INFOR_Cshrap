...
//CLASS NAME: InsertOverrideForItemPieces.cs
...
{
	public class InsertOverrideForItemPieces : IInsertOverrideForItemPieces
	{
		readonly IApplicationDB appDB;
		
		
		public InsertOverrideForItemPieces(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		Guid? RowPointer = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InsertOverrideForItemPiecesSp";
				...
				return (Severity, Infobar, RowPointer);
			}
		}
	}
}
