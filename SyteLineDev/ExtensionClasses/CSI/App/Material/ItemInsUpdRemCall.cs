...
//CLASS NAME: ItemInsUpdRemCall.cs
...
{
	public class ItemInsUpdRemCall : IItemInsUpdRemCall
	{
		readonly IApplicationDB appDB;
		
		
		public ItemInsUpdRemCall(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string FreightClass = null)
		{
			...
			QtyUnitNoNegType _Length = Length;
			QtyUnitNoNegType _Width = Width;
			QtyUnitNoNegType _Height = Height;
			UMType _DimensionUM = DimensionUM;
			DoPackageTypeType _PackageType = PackageType;
			QtyUnitNoNegType _PackageTypeMaxQty = PackageTypeMaxQty;
			ListYesNoType _Hazard = Hazard;
			ShippingNameType _ShippingName = ShippingName;
			UNNumType _UNNum = UNNum;
			HazardousMatlPackageGroupType _HazardousMatlPackageGroup = HazardousMatlPackageGroup;
			HazardousMatlClassType _HazardousMatlClass = HazardousMatlClass;
			HazardousMatlContactNameType _HazmatContact = HazmatContact;
			PhoneType _HazmatContactPhone = HazmatContactPhone;
			ListYesNoType _HazmatPlacardRequired = HazmatPlacardRequired;
			DoMotorFreightCodeType _NationalMotorFreightClass = NationalMotorFreightClass;
			FreightClassType _FreightClass = FreightClass;

			using (IDbCommand cmd = appDB.CreateCommand())
			{
				
				cmd.CommandType = CommandType.StoredProcedure;
				cmd.CommandText = "ItemInsUpdRemCallSP";
				...
				appDB.AddCommandParameter(cmd, "DimensionUM", _DimensionUM, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PackageType", _PackageType, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PackageTypeMaxQty", _PackageTypeMaxQty, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "Hazard", _Hazard, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "ShippingName", _ShippingName, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "UNNum", _UNNum, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "HazardousMatlPackageGroup", _HazardousMatlPackageGroup, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "HazardousMatlClass", _HazardousMatlClass, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "HazmatContact", _HazmatContact, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "HazmatContactPhone", _HazmatContactPhone, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "HazmatPlacardRequired", _HazmatPlacardRequired, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "NationalMotorFreightClass", _NationalMotorFreightClass, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "FreightClass", _FreightClass, ParameterDirection.Input);
				...
				return (Severity, Item, RecordDate);
			}
		}
	}
}
