...
//CLASS NAME: SerialNumValidation.cs
...
{
	public class SerialNumValidation : ISerialNumValidation
	{
		readonly IApplicationDB appDB;
		
		
		public SerialNumValidation(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SerialNumValidationSp";
