...
//CLASS NAME: CombineXferShipReceiveSetVars.cs
...
{
	public interface ICombineXferShipReceiveSetVars
	{
		(int? ReturnCode, string Infobar) CombineXferShipReceiveSetVarsSp(string SET,
		string TrnNum,
		short? TrnLine,
		string Item,
		string FromSite,
	...
	public class CombineXferShipReceiveSetVars : ICombineXferShipReceiveSetVars
	{
		readonly IApplicationDB appDB;
		
		public CombineXferShipReceiveSetVars(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) CombineXferShipReceiveSetVarsSp(string SET,
		string TrnNum,
		short? TrnLine,
		string Item,
		string FromSite,
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CombineXferShipReceiveSetVarsSp";
