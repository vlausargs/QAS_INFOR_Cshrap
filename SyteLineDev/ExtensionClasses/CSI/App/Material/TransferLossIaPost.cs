...
//CLASS NAME: TransferLossIaPost.cs
...
{
	public class TransferLossIaPost : ITransferLossIaPost
	{
		readonly IApplicationDB appDB;
		
		
		public TransferLossIaPost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) TransferLossIaPostSp(string TrxType,
		DateTime? TransDate,
		string Acct = null,
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "TransferLossIaPostSp";
