...
//CLASS NAME: InsertItemPiecesForPurchaseOrderReveicing.cs
...
{
	public class InsertItemPiecesForPurchaseOrderReveicing : IInsertItemPiecesForPurchaseOrderReveicing
	{
		readonly IApplicationDB appDB;
		
		
		public InsertItemPiecesForPurchaseOrderReveicing(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) InsertItemPiecesForPurchaseOrderReveicingSp(string RefNum,
		int? RefLineSuffix,
		int? RefRelease,
		string Item,
		string Whse,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InsertItemPiecesForPurchaseOrderReveicingSp";
