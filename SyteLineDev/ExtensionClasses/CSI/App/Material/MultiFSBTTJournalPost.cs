...
//CLASS NAME: MultiFSBTTJournalPost.cs
...
{
	public class MultiFSBTTJournalPost : IMultiFSBTTJournalPost
	{
		readonly IApplicationDB appDB;
		
		public MultiFSBTTJournalPost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "MultiFSBTTJournalPostSp";
