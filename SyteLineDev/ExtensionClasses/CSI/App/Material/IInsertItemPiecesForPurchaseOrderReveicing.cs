...
//CLASS NAME: IInsertItemPiecesForPurchaseOrderReveicing.cs
...
{
	public interface IInsertItemPiecesForPurchaseOrderReveicing
	{
		(int? ReturnCode, string Infobar) InsertItemPiecesForPurchaseOrderReveicingSp(string RefNum,
		int? RefLineSuffix,
		int? RefRelease,
		string Item,
		string Whse,
