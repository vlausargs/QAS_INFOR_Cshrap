...
//CLASS NAME: InsertOrUpdateForItemPiecesMv.cs
...
{
	public class InsertOrUpdateForItemPiecesMv : IInsertOrUpdateForItemPiecesMv
	{
		readonly IApplicationDB appDB;
		
		
		public InsertOrUpdateForItemPiecesMv(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) InsertOrUpdateForItemPiecesMvSp(Guid? FromPiecesRowPointer,
		string Item,
		string Whse,
		string FromLoc,
		string ToLoc,
		...
		string Infobar)
		{
			RowPointerType _FromPiecesRowPointer = FromPiecesRowPointer;
			ItemType _Item = Item;
			WhseType _Whse = Whse;
			...
			PieceCountType _Adjustment = Adjustment;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InsertOrUpdateForItemPiecesMvSp";
				
				appDB.AddCommandParameter(cmd, "FromPiecesRowPointer", _FromPiecesRowPointer, ParameterDirection.Input);
				...
				appDB.AddCommandParameter(cmd, "Adjustment", _Adjustment, ParameterDirection.Input);
