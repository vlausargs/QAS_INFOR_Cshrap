...
//CLASS NAME: PostAdjTransWrapper.cs
...
{
	public interface IPostAdjTransWrapper
	{
		(int? ReturnCode, decimal? MatlCost, decimal? LbrCost, decimal? FovhdCost, decimal? VovhdCost, decimal? OutCost, decimal? TotalCost, decimal? ProfitMarkup, string Infobar, string PromptMsg, string PromptButtons) PostAdjTransWrapperSp(string TrxType,
		DateTime? TransDate,
		string Acct = null,
	...
	public class PostAdjTransWrapper : IPostAdjTransWrapper
	{
		readonly IApplicationDB appDB;
		
		public PostAdjTransWrapper(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, decimal? MatlCost, decimal? LbrCost, decimal? FovhdCost, decimal? VovhdCost, decimal? OutCost, decimal? TotalCost, decimal? ProfitMarkup, string Infobar, string PromptMsg, string PromptButtons) PostAdjTransWrapperSp(string TrxType,
		DateTime? TransDate,
		string Acct = null,
		string AcctUnit1 = null,
		string AcctUnit2 = null,
		...
		string PromptButtons = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "PostAdjTransWrapperSp";
				...
				return (Severity, MatlCost, LbrCost, FovhdCost, VovhdCost, OutCost, TotalCost, ProfitMarkup, Infobar, PromptMsg, PromptButtons);
			}
		}
	}
}
