...
{
	public interface IMsmpSetVars
	{
		(int? ReturnCode, decimal? PUnitCost, decimal? PMatlCost, decimal? PLbrCost, decimal? PFovhdCost, decimal? PVovhdCost, decimal? POutCost, decimal? PTotCost, string Infobar) MsmpSetVarsSp(string SET,
		string PType,
		DateTime? PDate,
		decimal? PQty,
		string PItem,
	...
	public class MsmpSetVars : IMsmpSetVars
	{
		readonly IApplicationDB appDB;
		
		public MsmpSetVars(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, decimal? PUnitCost, decimal? PMatlCost, decimal? PLbrCost, decimal? PFovhdCost, decimal? PVovhdCost, decimal? POutCost, decimal? PTotCost, string Infobar) MsmpSetVarsSp(string SET,
		string PType,
		DateTime? PDate,
		decimal? PQty,
		string PItem,
