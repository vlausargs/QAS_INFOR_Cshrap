...
//CLASS NAME: IInsertOverrideForItemLotAttrAll.cs
...
{
	public interface IInsertOverrideForItemLotAttrAll
	{
		(int? ReturnCode, string Infobar) InsertOverrideForItemLotAttrAllSp(string Item,
		string Lot,
