...
//CLASS NAME: TransferOrderReceive.cs
...
{
	public class TransferOrderReceive : ITransferOrderReceive
	{
		readonly IApplicationDB appDB;
		
		
		public TransferOrderReceive(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) TransferOrderReceiveSp(string TrnNum,
		int? TrnLine,
		string Item,
		string FromSite,
		string FromWhse,
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "TransferOrderReceiveSp";
