...
//CLASS NAME: InsertOverrideForItemLotAttrAll.cs
...
{
	public class InsertOverrideForItemLotAttrAll : IInsertOverrideForItemLotAttrAll
	{
		readonly IApplicationDB appDB;
		
		
		public InsertOverrideForItemLotAttrAll(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) InsertOverrideForItemLotAttrAllSp(string Item,
		string Lot,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InsertOverrideForItemLotAttrAllSp";
				...
				appDB.AddCommandParameter(cmd, "LotAttrGroup", _LotAttrGroup, ParameterDirection.Input);
