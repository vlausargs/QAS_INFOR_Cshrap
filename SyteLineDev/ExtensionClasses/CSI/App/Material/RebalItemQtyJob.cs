...
{
	public class RebalItemQtyJob : IRebalItemQtyJob
	{
		readonly IApplicationDB appDB;
		
		
		public RebalItemQtyJob(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) RebalItemQtyJobSp(string Infobar,
		...
		string EndingWhse = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RebalItemQtyJobSp";
