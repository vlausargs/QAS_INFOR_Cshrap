...
{
	public interface ITrnShipQtyValid
	{
		(int? ReturnCode, string PromptButtons1, string PromptMsg1, string PromptButtons2, string PromptMsg2, string PromptButtons3, string PromptMsg3, string Infobar, byte? CallForm, DateTime? RecordDate) TrnShipQtyValidSp(string TrnNum,
		short? TrnLine,
		double? UmConvFactor,
		decimal? QtyToShip,
		string FromLoc,
	...
	public class TrnShipQtyValid : ITrnShipQtyValid
	{
		readonly IApplicationDB appDB;
		
		public TrnShipQtyValid(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string PromptButtons1, string PromptMsg1, string PromptButtons2, string PromptMsg2, string PromptButtons3, string PromptMsg3, string Infobar, byte? CallForm, DateTime? RecordDate) TrnShipQtyValidSp(string TrnNum,
		short? TrnLine,
		double? UmConvFactor,
		decimal? QtyToShip,
		string FromLoc,
		...
		DateTime? RecordDate = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "TrnShipQtyValidSp";
