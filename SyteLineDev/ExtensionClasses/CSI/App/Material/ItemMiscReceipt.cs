...
{
	public class ItemMiscReceipt : IItemMiscReceipt
	{
		readonly IApplicationDB appDB;
		
		
		public ItemMiscReceipt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) ItemMiscReceiptSp(string P_Item,
		string P_Whse,
		decimal? P_Qty,
		string P_UM,
		decimal? P_MatlCost,
		...
		string UMArea = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ItemMiscReceiptSp";
