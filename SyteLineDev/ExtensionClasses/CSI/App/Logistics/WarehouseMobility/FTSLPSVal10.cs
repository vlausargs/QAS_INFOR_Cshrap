...
{
	public interface IFTSLPSVal10
	{
		(int? ReturnCode, string PSNum, string UM, byte? LotTracked, byte? SerTracked, string Whse, string Wc, int? OperNum, string PSItemJob, short? PSItemSuffix, decimal? QtyComplete, string Infobar) FTSLPSVal10Sp(string PSItem,
		byte? Cmpl = (byte)0,
		string PSNum = null,
		string UM = null,
	...
	public class FTSLPSVal10 : IFTSLPSVal10
	{
		readonly IApplicationDB appDB;
		
		public FTSLPSVal10(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string PSNum, string UM, byte? LotTracked, byte? SerTracked, string Whse, string Wc, int? OperNum, string PSItemJob, short? PSItemSuffix, decimal? QtyComplete, string Infobar) FTSLPSVal10Sp(string PSItem,
		byte? Cmpl = (byte)0,
		string PSNum = null,
		string UM = null,
		byte? LotTracked = null,
		...
		string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				return (Severity, PSNum, UM, LotTracked, SerTracked, Whse, Wc, OperNum, PSItemJob, PSItemSuffix, QtyComplete, Infobar);
			}
		}
	}
}
