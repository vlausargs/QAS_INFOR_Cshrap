...
//CLASS NAME: CLM_FTSLLoadXdocOrderItems.cs
...
{
	public class CLM_FTSLLoadXdocOrderItems : ICLM_FTSLLoadXdocOrderItems
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_FTSLLoadXdocOrderItems(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CLM_FTSLLoadXdocOrderItemsSp(string Item,
		string Whse,
		string Job,
		int? priority_1,
		int? priority_2,
		...
		int? future_days_4)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CLM_FTSLLoadXdocOrderItemsSp";
