...
//CLASS NAME: CLM_ARCashImpact.cs
...
{
    public class CLM_ARCashImpact : ICLM_ARCashImpact
    {
        ...
        public CLM_ARCashImpact(IApplicationDB appDB,
            ...
            string FilterString = null)
        {
            ...
            try
            {
                ...
                if (existsChecker.Exists(tableName: "optional_module",
                    ...
                    whereClause: collectionLoadRequestFactory.Clause("ISNULL([om].[is_enabled], 0) = 1 AND OBJECT_ID(QUOTENAME('CLM_ARCashImpactSp' + CHAR(95) + [om].[ModuleName])) IS NOT NULL")))
                {
                    ...
                    {
                        optional_module1Item.SetValue<string>("SpName", stringUtil.QuoteName(stringUtil.Concat("CLM_ARCashImpactSp", stringUtil.Char(95), optional_module1Item.GetValue<string>("u0"))));
                    };
                        ...
                        whereClause: collectionLoadRequestFactory.Clause("")))
                    {
                        ...
                        var ALTGEN = AltExtGen_CLM_ARCashImpactSp(ALTGEN_SpName,
                            TransactionType,
                            FilterString);
                ...
                if (this.scalarFunction.Execute<int?>("OBJECT_ID", "dbo.EXTGEN_CLM_ARCashImpactSp") != null)
                {
                    var EXTGEN = AltExtGen_CLM_ARCashImpactSp("dbo.EXTGEN_CLM_ARCashImpactSp",
                        TransactionType,
                        FilterString);
                ...
                var tv_RptMainSetExecResult = this.iRpt_CashImpactSub.Rpt_CashImpactSubSp(
                    SummaryOrDetail: "S",
                ...
                #region CRUD InsertByRecords
                var TotalCash1InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                ...
                #region CRUD InsertByRecords
                var TotalCash2InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                ...
                #region CRUD InsertByRecords
                var TotalCash3InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                ...
                #region CRUD InsertByRecords
                var TotalCash4InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                ...
                #region CRUD InsertByRecords
                var TotalCash5InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                ...
                #region CRUD LoadToRecord
                var TotalCash6LoadRequest = collectionLoadRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
                    {
                        {"CashImpactType","CashImpactType"},
                        {"AsOfDate","Date6"},
                    ...
                    whereClause: collectionLoadRequestFactory.Clause(""),
                    orderByClause: collectionLoadRequestFactory.Clause(""));
                var TotalCash6LoadResponse = this.appDB.Load(TotalCash6LoadRequest);
                #endregion  LoadToRecord

                #region CRUD InsertByRecords
                var TotalCash6InsertRequest = collectionInsertRequestFactory.SQLInsert(tableName: "#TotalCash",
                    items: TotalCash6LoadResponse.Items);

                this.appDB.Insert(TotalCash6InsertRequest);
                #endregion InsertByRecords
                ...
                FilterString = stringUtil.Replace(
                    ...
                    "= NULL",
                    "IS NULL");
                WhereStr = @" WHERE CashImpactType IN ('ARTransaction','CustomerOrder', 'ProgressiveBill', 'COBlanketLine',  'EstimateOrder', 'TotalCashIn')
                   AND CashImpactType = @TransactionType ";
                ...
                var BuildXMLFilterString = this.iBuildXMLFilterString.BuildXMLFilterStringSp(
                    PropertyName: "CashImpactType",
                    Value: TransactionType,
                    DataType: "nvarchar(30)",
                    NameInParmList: "@TransactionType",
                ...
                this.sQLExpressionExecutor.Execute(@"Declare
                     ...
                     SELECT ' SELECT * ' AS SelectionClause,
                            ' FROM #TotalCash ' AS FromClause,
                            @WhereStr AS WhereClause,
                            N' ORDER BY CashImpactType, AsOfDate ' AS AdditionalClause,
                            N'CashImpactType, AsOfDate' AS KeyColumns,
                ...
                var DynamicParametersLoadRequest = collectionLoadStatementRequestFactory.SQLLoad(columnExpressionByColumnName: new Dictionary<string, string>()
                    {
                        ...
                        {"WhereClause",$"{variableUtil.GetValue<string>(WhereStr)}"},
                        {"AdditionalClause","N' ORDER BY CashImpactType, AsOfDate '"},
                        {"KeyColumns","N'CashImpactType, AsOfDate'"},
