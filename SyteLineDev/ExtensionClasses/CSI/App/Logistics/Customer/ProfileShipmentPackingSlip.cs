...
//CLASS NAME: ProfileShipmentPackingSlip.cs
...
{
	public interface IProfileShipmentPackingSlip
	{
		(ICollectionLoadResponse Data, int? ReturnCode) ProfileShipmentPackingSlipSp(decimal? ShipmentStarting = null,
	...
	public class ProfileShipmentPackingSlip : IProfileShipmentPackingSlip
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public ProfileShipmentPackingSlip(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) ProfileShipmentPackingSlipSp(decimal? ShipmentStarting = null,
		decimal? ShipmentEnding = null,
		string CustomerStarting = null,
		string CustomerEnding = null,
		int? CustSeqStarting = null,
		...
		byte? DisplayHeader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProfileShipmentPackingSlipSp";
