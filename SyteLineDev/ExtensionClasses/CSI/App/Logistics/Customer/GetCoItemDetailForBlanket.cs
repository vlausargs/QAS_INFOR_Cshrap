...
//CLASS NAME: GetCoItemDetailForBlanket.cs
...
{
	public class GetCoItemDetailForBlanket : IGetCoItemDetailForBlanket
	{
		readonly IApplicationDB appDB;
		
		
		public GetCoItemDetailForBlanket(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string CoCustNum,
		string CoCustName,
		...
		string ManufacturerName)
		{
			...
			CurrCodeType _CoCurrCode = CoCurrCode;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "GetCoItemDetailForBlanketSp";
				...
				appDB.AddCommandParameter(cmd, "CoCurrCode", _CoCurrCode, ParameterDirection.InputOutput);
