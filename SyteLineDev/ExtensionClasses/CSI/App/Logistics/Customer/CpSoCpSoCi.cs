...
{
	public class CpSoCpSoCi : ICpSoCpSoCi
	{
		readonly IApplicationDB appDB;
		
		
		public CpSoCpSoCi(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) CpSoCpSoCiSp(string PFromCoType,
		string PFromCoNum,
		int? PFromCoLine,
		string PFromCurr,
		string PToCoNum,
