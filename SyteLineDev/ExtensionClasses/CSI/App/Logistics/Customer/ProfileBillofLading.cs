...
//CLASS NAME: ProfileBillofLading.cs
...
{
	public interface IProfileBillofLading
	{
		(ICollectionLoadResponse Data, int? ReturnCode) ProfileBillofLadingSp(string DOStarting = null,
	...
	public class ProfileBillofLading : IProfileBillofLading
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public ProfileBillofLading(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) ProfileBillofLadingSp(string DOStarting = null,
		string DOEnding = null,
		string CustomerStarting = null,
		string CustomerEnding = null,
		int? CustSeqStarting = null,
		...
		byte? DisplayHeader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProfileBillofLadingSp";
