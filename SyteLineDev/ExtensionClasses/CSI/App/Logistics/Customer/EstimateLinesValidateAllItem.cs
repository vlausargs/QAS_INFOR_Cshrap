...
//CLASS NAME: EstimateLinesValidateAllItem.cs
...
{
	public class EstimateLinesValidateAllItem : IEstimateLinesValidateAllItem
	{
		readonly IApplicationDB appDB;
		
		
		public EstimateLinesValidateAllItem(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Site = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EstimateLinesValidateAllItemSp";
