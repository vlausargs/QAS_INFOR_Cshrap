...
{
	public class TaxDistUpdate : ITaxDistUpdate
	{
		readonly IApplicationDB appDB;
		
		
		public TaxDistUpdate(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) TaxDistUpdateSp(Guid? PRowPointer,
		string PCoNum,
		int? PSeq,
		int? PTaxSystem,
		string PTaxCode,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "TaxDistUpdateSp";
