...
//CLASS NAME: AU_CalculateCustomeOrderLinePrice.cs
...
{
	public class AU_CalculateCustomeOrderLinePrice : IAU_CalculateCustomeOrderLinePrice
	{
		readonly IApplicationDB appDB;
		
		public AU_CalculateCustomeOrderLinePrice(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string ConTractID = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "AU_CalculateCustomeOrderLinePriceSp";
