...
//CLASS NAME: CustomerInsUpdRemCall.cs
...
{
	public interface ICustomerInsUpdRemCall
	{
		(int? ReturnCode, string CustNum,
		int? CustSeq,
		string Infobar) CustomerInsUpdRemCallSp(string Site,
		string CustNum,
		byte? ApsPullUp = (byte)0,
		decimal? AvgBalOs = null,
		short? AvgDaysOs = null,
		...
		byte? DraftPrintFlag = null,
		byte? Einvoice = (byte)0,
		string EndUserType = null,
		byte? FinChg = (byte)0,
		byte? IncludeTaxInPrice = null,
		...
		short? NumPeriods = null,
		byte? OnePackInv = (byte)0,
		byte? PayDay = null,
		...
		string Phone_1 = null,
		string Phone_3 = null,
		byte? PrintPackInv = (byte)0,
		string ProcessInd = null,
		byte? RevisionDay = null,
		...
		byte? SepaCoreDirectDebit = null,
		byte? SepaOneOffMandate = null,
		...
		string Infobar = null,
		byte? OneShipmentInv = (byte)0,
		string ShipMethodGroup = null,
		string Stat = null,
		byte? UseLongName = (byte)0,
		string LongName = null);
	}
	
	public class CustomerInsUpdRemCall : ICustomerInsUpdRemCall
	{
		readonly IApplicationDB appDB;
		
		public CustomerInsUpdRemCall(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string LongName = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CustomerInsUpdRemCallSp";
