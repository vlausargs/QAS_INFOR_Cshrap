...
{
    public interface ICLM_RetransmitEdiAck
    {
        (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) CLM_RetransmitEdiAckSp(string CoNumStarting = null,
    ...
    public class CLM_RetransmitEdiAck : ICLM_RetransmitEdiAck
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;

        public CLM_RetransmitEdiAck(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
        {
            this.appDB = appDB;
        ...
        public (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) CLM_RetransmitEdiAckSp(string CoNumStarting = null,
        string CoNumEnding = null,
        string CustomerStarting = null,
        string CustomerEnding = null,
        DateTime? CDateStarting = null,
