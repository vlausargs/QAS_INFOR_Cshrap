...
{
	public interface IEuroCustSites
	{
		(ICollectionLoadResponse Data, int? ReturnCode, string rInfobar) EuroCustSitesSp(string pBeginCustNum1,
		string pEndCustNum1,
