...
{
    public interface ICLM_RetransmitEdiASN
    {
        (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) CLM_RetransmitEdiASNSp(string CustomerStarting = null,
    ...
    public class CLM_RetransmitEdiASN : ICLM_RetransmitEdiASN
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;

        public CLM_RetransmitEdiASN(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
        {
            this.appDB = appDB;
        ...
        public (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) CLM_RetransmitEdiASNSp(string CustomerStarting = null,
        string CustomerEnding = null,
        DateTime? CDateStarting = null,
        DateTime? CDateEnding = null,
        short? CDateStartingOffset = null,
