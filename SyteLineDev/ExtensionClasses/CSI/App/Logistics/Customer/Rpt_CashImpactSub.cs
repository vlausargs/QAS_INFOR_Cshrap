...
//CLASS NAME: Rpt_CashImpactSub.cs
...
{
    public class Rpt_CashImpactSub : IRpt_CashImpactSub
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;

        public Rpt_CashImpactSub(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
        {
            this.appDB = appDB;
        ...
        public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_CashImpactSubSp(
            ...
            int? OnlyNeedTotals = 1)
        {
            ...
            ListYesNoType _OnlyNeedTotals = OnlyNeedTotals;
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "Rpt_CashImpactSubSp";
                ...
                appDB.AddCommandParameter(cmd, "OnlyNeedTotals", _OnlyNeedTotals, ParameterDirection.Input);
