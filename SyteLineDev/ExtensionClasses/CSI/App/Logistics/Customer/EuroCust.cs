...
{
	public class EuroCust : IEuroCust
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public EuroCust(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode, string rInfobar) EuroCustSp(string pProcess,
		...
		string rInfobar = null)
		{
			...
			CurrCodeType _pInCurrencyCode = pInCurrencyCode;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				appDB.AddCommandParameter(cmd, "pInCurrencyCode", _pInCurrencyCode, ParameterDirection.Input);
