...
//CLASS NAME: Home_JobVarianceOper.cs
...
{
	public class Home_JobVarianceOper : IHome_JobVarianceOper
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Home_JobVarianceOper(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Home_JobVarianceOperSp(string FilterString = null,
		string JobJob = null,
		int? JobSuffix = null,
		string Item = null,
		...
		string SiteGroup = null)
		{
			...
			try
			{
				...
				using (IDbCommand cmd = appDB.CreateCommand())
				{
					...
					cmd.CommandText = "Home_JobVarianceOperSp";
