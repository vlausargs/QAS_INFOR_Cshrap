...
//CLASS NAME: ProfileAPCheckPrintingPosting.cs
...
{
	public class ProfileAPCheckPrintingPosting : IProfileAPCheckPrintingPosting
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public ProfileAPCheckPrintingPosting(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) ProfileAPCheckPrintingPostingSp(Guid? ProcessID = null,
		...
		string EndVendName = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProfileAPCheckPrintingPostingSp";
