...
{
	public class SaveAptrxp : ISaveAptrxp
	{
		readonly IApplicationDB appDB;
		
		
		public SaveAptrxp(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) SaveAptrxpSp(string VendNum,
		int? Voucher,
		int? VouchSeq,
		string PType,
		string Sites,
