...
{
    public interface IAppmtdLeaveType
    {
        int AppmtdLeaveTypeSp(string PSite,
                              string PType,
                              string PVendNum,
                              string PBankCode,
                              short? PCheckSeq,
    ...
    public class AppmtdLeaveType : IAppmtdLeaveType
    {
        readonly IApplicationDB appDB;

        public AppmtdLeaveType(IApplicationDB appDB)
        {
            this.appDB = appDB;
        }
                                     ...
                                     ref byte? PAcctIsControl)
        {
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "AppmtdLeaveTypeSp";
