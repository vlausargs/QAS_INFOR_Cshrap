...
//CLASS NAME: RetransmitEDIPurchaseOrders.cs
...
{
	public interface ICLM_RetransmitEDIPurchaseOrders
	{
	...
	public class CLM_RetransmitEDIPurchaseOrders : ICLM_RetransmitEDIPurchaseOrders
    {
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_RetransmitEDIPurchaseOrders(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) RetransmitEDIPurchaseOrdersSp(string VendorStarting = null,
		                                                                                                     string VendorEnding = null,
		                                                                                                     string PoStarting = null,
		                                                                                                     string PoEnding = null,
		                                                                                                     DateTime? CDateStarting = null,
		                                                                                                     ...
		                                                                                                     string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RetransmitEDIPurchaseOrdersSp";
