...
//CLASS NAME: WBPoRcptReturnPercentage.cs
...
{
	public class WBPoRcptReturnPercentage : IWBPoRcptReturnPercentage
	{
		readonly IApplicationDB appDB;
		
		
		public WBPoRcptReturnPercentage(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, decimal? Amount) WBPoRcptReturnPercentageSp(DateTime? AsOfDate,
		int? KPINum,
		decimal? Amount,
		string Parm1 = null,
		string Parm2 = null,
		...
		string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBPoRcptReturnPercentageSp";
