...
//CLASS NAME: AU_NextPoContract.cs
...
{
	public class AU_NextPoContract : IAU_NextPoContract
	{
		readonly IApplicationDB appDB;
		
		public AU_NextPoContract(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "AU_NextPoContractSp";
