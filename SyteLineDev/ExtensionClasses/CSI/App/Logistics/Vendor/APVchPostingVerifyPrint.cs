...
//CLASS NAME: APVchPostingVerifyPrint.cs
...
{
	public class APVchPostingVerifyPrint : IAPVchPostingVerifyPrint
	{
		readonly IApplicationDB appDB;
		
		
		public APVchPostingVerifyPrint(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "APVchPostingVerifyPrintSp";
