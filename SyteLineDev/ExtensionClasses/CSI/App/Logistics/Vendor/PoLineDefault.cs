...
{
	public class PoLineDefault : IPoLineDefault
	{
		readonly IApplicationDB appDB;
		
		
		public PoLineDefault(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string CurrAmtFormat = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "PoLineDefaultSp";
				...
				return (Severity, Stat, OrderDate, VendNum, VendorName, VendOrder, CurrCode, PoExchRate, Whse, PoTaxCode1, PoTaxCode2, TransNat, TransNat2, Delterm, ProcessInd, EcCode, FirstLine, PoChgNum, PoChgDate, PoChgStat, CurrAmtTotFormat, CurrCstPrcFormat, Infobar, CurrAmtFormat);
			}
		}
	}
}
