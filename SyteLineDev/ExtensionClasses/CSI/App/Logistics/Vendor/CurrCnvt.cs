...
{
    public class CurrCnvt : ICurrCnvt
    {
        readonly IApplicationDB appDB;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
        readonly IDataTableUtil dataTableUtil;

        public CurrCnvt(IApplicationDB appDB, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse, IDataTableUtil dataTableUtil)
        {
            this.appDB = appDB;
        ...
        public ICollectionLoadResponse CurrCnvtFn(
            string CurrCode,
            int? FromDomestic,
            int? UseBuyRate,
            int? RoundResult,
            ...
            decimal? Amount15 = null)
        {
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "SELECT * FROM dbo.[CurrCnvt](@CurrCode, @FromDomestic, @UseBuyRate, @RoundResult, @Date, @RoundPlaces, @UseCustomsAndExciseRates, @ForceRate, @TRate, @Site, @DomCurrCode, @TRateD, @Amount1, @Amount2, @Amount3, @Amount4, @Amount5, @Amount6, @Amount7, @Amount8, @Amount9, @Amount10, @Amount11, @Amount12, @Amount13, @Amount14, @Amount15)";
                ...
                dtReturn.TableName = "#fnt_CurrCnvt";
