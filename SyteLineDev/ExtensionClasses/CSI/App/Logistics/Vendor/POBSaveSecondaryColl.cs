...
//CLASS NAME: POBSaveSecondaryColl.cs
...
{
	public class POBSaveSecondaryColl : IPOBSaveSecondaryColl
	{
		readonly IApplicationDB appDB;
		
		
		public POBSaveSecondaryColl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		Guid? ApsPlanRowPointer)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "POBSaveSecondaryCollSp";
