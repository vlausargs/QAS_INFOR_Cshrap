...
//CLASS NAME: AppmtLeavePayToVendAmt.cs
...
{
	public class AppmtLeavePayToVendAmt : IAppmtLeavePayToVendAmt
	{
		readonly IApplicationDB appDB;
		
		
		public AppmtLeavePayToVendAmt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "AppmtLeavePayToVendAmtSp";
