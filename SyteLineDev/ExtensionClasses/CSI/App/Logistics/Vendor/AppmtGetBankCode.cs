...
//CLASS NAME: AppmtGetBankCode.cs
...
{
	public class AppmtGetBankCode : IAppmtGetBankCode
	{
		readonly IApplicationDB appDB;
		
		
		public AppmtGetBankCode(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "AppmtGetBankCodeSp";
