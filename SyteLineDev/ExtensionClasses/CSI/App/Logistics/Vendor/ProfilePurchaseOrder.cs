...
//CLASS NAME: ProfilePurchaseOrder.cs
...
{
	public interface IProfilePurchaseOrder
	{
		(ICollectionLoadResponse Data, int? ReturnCode) ProfilePurchaseOrderSp(string pPoType = null,
		string pPoStat = null,
	...
	public class ProfilePurchaseOrder : IProfilePurchaseOrder
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public ProfilePurchaseOrder(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) ProfilePurchaseOrderSp(string pPoType = null,
		string pPoStat = null,
		string pPoitemStat = null,
		string pPrintItemVI = null,
		string pStartPoNum = null,
		...
		byte? IncludeBlnsWOReleases = (byte)0)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProfilePurchaseOrderSp";
