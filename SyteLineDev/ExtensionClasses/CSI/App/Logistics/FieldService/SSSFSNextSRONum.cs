...
{
	public class SSSFSNextSRONum : ISSSFSNextSRONum
	{
		readonly IApplicationDB appDB;
		
		public SSSFSNextSRONum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSNextSRONumSp";
