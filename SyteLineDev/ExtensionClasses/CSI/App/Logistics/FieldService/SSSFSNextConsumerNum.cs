...
//CLASS NAME: SSSFSNextConsumerNum.cs
...
{
	public class SSSFSNextConsumerNum : ISSSFSNextConsumerNum
	{
		readonly IApplicationDB appDB;
		
		public SSSFSNextConsumerNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSNextConsumerNumSp";
