...
//CLASS NAME: SSSFSSROWipRelSubRelieveMatl.cs
...
{
	public class SSSFSSROWipRelSubRelieveMatl : ISSSFSSROWipRelSubRelieveMatl
	{
		readonly IApplicationDB appDB;
		
		public SSSFSSROWipRelSubRelieveMatl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSSROWipRelSubRelieveMatlSp";
