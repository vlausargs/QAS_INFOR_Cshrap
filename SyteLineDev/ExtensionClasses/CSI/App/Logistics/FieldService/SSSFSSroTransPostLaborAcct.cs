...
//CLASS NAME: SSSFSSroTransPostLaborAcct.cs
...
{
	public class SSSFSSroTransPostLaborAcct : ISSSFSSroTransPostLaborAcct
	{
		readonly IApplicationDB appDB;
		
		public SSSFSSroTransPostLaborAcct(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string oSaleDsUnit3,
			string oSaleDsUnit4,
			string Infobar) SSSFSSroTransPostLaborAcctSp(
			string iMode,
			Guid? iRowPointer,
			string InSroNum,
			int? InSroLine,
			...
			string Infobar)
		{
			...
			FSWorkCodeType _InWorkCode = InWorkCode;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSSroTransPostLaborAcctSp";
				...
				appDB.AddCommandParameter(cmd, "InWorkCode", _InWorkCode, ParameterDirection.Input);
