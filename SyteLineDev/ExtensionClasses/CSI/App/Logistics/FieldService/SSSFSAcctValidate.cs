...
//CLASS NAME: SSSFSAcctValidate.cs
...
{
	public class SSSFSAcctValidate : ISSSFSAcctValidate
	{
		readonly IApplicationDB appDB;
		
		public SSSFSAcctValidate(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSAcctValidateSp";
