...
//CLASS NAME: SSSFSArpmtdChgSroNum.cs
...
{
	public class SSSFSArpmtdChgSroNum : ISSSFSArpmtdChgSroNum
	{
		readonly IApplicationDB appDB;
		
		
		public SSSFSArpmtdChgSroNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		decimal? PArpmtPaymentExchRate)
		{
			...
			FSSRONumType _PArpmtdSroNum = PArpmtdSroNum;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSArpmtdChgSroNumSp";
				
				appDB.AddCommandParameter(cmd, "PArpmtdSite", _PArpmtdSite, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PArpmtdSroNum", _PArpmtdSroNum, ParameterDirection.Input);
				...
				return (Severity, PArpmtdApplyCustNum, PApplCustName, PFixedEuro, PArpmtdExchRate, PUpdateRate, PArpmtdForAmtApplied, PArpmtdForDiscAmt, PArpmtdDomAmtApplied, PArpmtdDomDiscAmt, PArpmtdDiscAcct, PArpmtdDiscAcctUnit1, PArpmtdDiscAcctUnit2, PArpmtdDiscAcctUnit3, PArpmtdDiscAcctUnit4, Infobar);
			}
		}
	}
}
