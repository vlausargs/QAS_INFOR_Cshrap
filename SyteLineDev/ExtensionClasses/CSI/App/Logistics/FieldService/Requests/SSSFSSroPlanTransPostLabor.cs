...
//CLASS NAME: SSSFSSroPlanTransPostLabor.cs
...
{
	public class SSSFSSroPlanTransPostLabor : ISSSFSSroPlanTransPostLabor
	{
		readonly IApplicationDB appDB;
		
		
		public SSSFSSroPlanTransPostLabor(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) SSSFSSroPlanTransPostLaborSp(Guid? iRowPointer,
		string iMode,
		string iPartnerId,
		string iDept,
		string iWhse,
		...
		string Infobar)
		{
			...
			QtyUnitType _iPstHrsWorked = iPstHrsWorked;
			QtyUnitType _iPstHrsToBill = iPstHrsToBill;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSSroPlanTransPostLaborSp";
				...
				appDB.AddCommandParameter(cmd, "iPstHrsWorked", _iPstHrsWorked, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "iPstHrsToBill", _iPstHrsToBill, ParameterDirection.Input);
