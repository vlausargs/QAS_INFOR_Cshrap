...
//CLASS NAME: SSSFSSROPackSlipLine_Load.cs
...
{
	public class SSSFSSROPackSlipLine_Load : ISSSFSSROPackSlipLine_Load
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public SSSFSSROPackSlipLine_Load(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) SSSFSSROPackSlipLine_LoadSp(int? PackNum = null,
		string SRONum = null,
		int? SROLine = null,
		int? SROOper = null,
		int? TransPosted = 0,
		...
		string FilterString = null)
		{
			...
			try
			{
				...
				using (IDbCommand cmd = appDB.CreateCommand())
				{
					...
					cmd.CommandText = "SSSFSSROPackSlipLine_LoadSp";
