...
//CLASS NAME: SSSFSKbaseSearch.cs
...
{
	public class SSSFSKbaseSearch : ISSSFSKbaseSearch
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public SSSFSKbaseSearch(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) SSSFSKbaseSearchSp(string SearchType,
		string SearchText,
		int? SearchKeywords,
		...
		string AvailableList)
		{
			...
			try
			{
				...
				using (IDbCommand cmd = appDB.CreateCommand())
				{
					...
					cmd.CommandText = "SSSFSKbaseSearchSp";
