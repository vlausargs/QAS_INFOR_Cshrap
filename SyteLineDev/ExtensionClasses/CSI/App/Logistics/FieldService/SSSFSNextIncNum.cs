...
{
	public class SSSFSNextIncNum : ISSSFSNextIncNum
	{
		readonly IApplicationDB appDB;
		
		public SSSFSNextIncNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSNextIncNumSp";
