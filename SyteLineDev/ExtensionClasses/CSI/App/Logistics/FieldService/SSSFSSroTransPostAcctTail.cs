...
//CLASS NAME: SSSFSSroTransPostAcctTail.cs
...
{
	public class SSSFSSroTransPostAcctTail : ISSSFSSroTransPostAcctTail
	{
		readonly IApplicationDB appDB;
		
		public SSSFSSroTransPostAcctTail(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string oSaleDsUnit3,
			string oSaleDsUnit4,
			string Infobar) SSSFSSroTransPostAcctTailSp(
			string InSroNum,
			int? InSroLine,
			int? InSroOper,
			string InBillCode,
			...
			string Infobar)
		{
			...
			ListYesNoType _InProjXref = InProjXref;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSSroTransPostAcctTailSp";
				...
				appDB.AddCommandParameter(cmd, "InProductCode", _InProductCode, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "InProjXref", _InProjXref, ParameterDirection.Input);
