...
//CLASS NAME: SSSFSNextContract.cs
...
{
	public class SSSFSNextContract : ISSSFSNextContract
	{
		readonly IApplicationDB appDB;
		
		public SSSFSNextContract(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSNextContractSp";
