...
//CLASS NAME: SSSFSSroTransPostMatlAcct.cs
...
{
	public class SSSFSSroTransPostMatlAcct : ISSSFSSroTransPostMatlAcct
	{
		readonly IApplicationDB appDB;
		
		public SSSFSSroTransPostMatlAcct(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			int? tImpactInventory = 1)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSSroTransPostMatlAcctSp";
