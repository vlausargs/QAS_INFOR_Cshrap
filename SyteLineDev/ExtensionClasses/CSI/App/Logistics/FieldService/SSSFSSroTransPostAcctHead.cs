...
//CLASS NAME: SSSFSSroTransPostAcctHead.cs
...
{
	public class SSSFSSroTransPostAcctHead : ISSSFSSroTransPostAcctHead
	{
		readonly IApplicationDB appDB;
		
		public SSSFSSroTransPostAcctHead(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string oSaleDsUnit3,
			string oSaleDsUnit4,
			string Infobar) SSSFSSroTransPostAcctHeadSp(
			int? InLineTrans,
			string InSroNum,
			int? InSroLine,
			int? InSroOper,
		...
		{
			ListYesNoType _InLineTrans = InLineTrans;
			...
			ProductCodeType _InProductCode = InProductCode;
			CostCodeType _ioCostCode = ioCostCode;
			ListYesNoType _oProjXref = oProjXref;
			...
			ListYesNoType _tImpactInventory = tImpactInventory;
			
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				
				cmd.CommandType = CommandType.StoredProcedure;
				cmd.CommandText = "SSSFSSroTransPostAcctHeadSp";
				
				appDB.AddCommandParameter(cmd, "InLineTrans", _InLineTrans, ParameterDirection.Input);
				...
				appDB.AddCommandParameter(cmd, "InProductCode", _InProductCode, ParameterDirection.InputOutput);
				appDB.AddCommandParameter(cmd, "ioCostCode", _ioCostCode, ParameterDirection.InputOutput);
				appDB.AddCommandParameter(cmd, "oProjXref", _oProjXref, ParameterDirection.InputOutput);
				...
				appDB.AddCommandParameter(cmd, "tImpactInventory", _tImpactInventory, ParameterDirection.Input);
				
				var Severity = appDB.ExecuteNonQuery(cmd);
				
				InProductCode = _InProductCode;
				ioCostCode = _ioCostCode;
				oProjXref = _oProjXref;
