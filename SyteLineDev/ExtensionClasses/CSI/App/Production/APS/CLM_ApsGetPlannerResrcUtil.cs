//PROJECT NAME: CSIAPS
//CLASS NAME: CLM_ApsGetPlannerResrcUtil.cs
...
{
    public interface ICLM_ApsGetPlannerResrcUtil
    {
        DataTable CLM_ApsGetPlannerResrcUtilSp(ApsAltNoType AltNum,
                                               DateType StartDate,
    ...
    public class CLM_ApsGetPlannerResrcUtil : ICLM_ApsGetPlannerResrcUtil
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;

        public CLM_ApsGetPlannerResrcUtil(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection)
        {
            this.appDB = appDB;
            this.bunchedLoadCollection = bunchedLoadCollection;
        }

        public DataTable CLM_ApsGetPlannerResrcUtilSp(ApsAltNoType AltNum,
                                                      DateType StartDate,
                                                      IntType IntervalCount,
                                                      IntType IntervalType,
                                                      DecimalType Threshold,
                                                      ...
                                                      LongListType FilterString)
        {
            ...
            try
            {
                using (IDbCommand cmd = appDB.CreateCommand())
                {
                    ...
                    cmd.CommandText = "CLM_ApsGetPlannerResrcUtilSp";
