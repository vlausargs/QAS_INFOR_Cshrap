...
{
	public class ApsOrderIns : IApsOrderIns
	{
		readonly IApplicationDB appDB;
		
		
		public ApsOrderIns(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		Guid? RowPointer)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				appDB.AddCommandParameter(cmd, "LodSiz", _LodSiz, ParameterDirection.Input);
