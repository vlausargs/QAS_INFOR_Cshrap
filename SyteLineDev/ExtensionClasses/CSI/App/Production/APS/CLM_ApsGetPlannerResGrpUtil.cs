...
//CLASS NAME: CLM_ApsGetPlannerResGrpUtil.cs
...
{
	public class CLM_ApsGetPlannerResGrpUtil : ICLM_ApsGetPlannerResGrpUtil
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_ApsGetPlannerResGrpUtil(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CLM_ApsGetPlannerResGrpUtilSp(int? AltNum,
		DateTime? StartDate,
		int? IntervalCount,
		int? IntervalType,
		decimal? Threshold,
		...
		string FilterString = null)
		{
			...
			try
			{
				...
				using (IDbCommand cmd = appDB.CreateCommand())
				{
					...
					cmd.CommandText = "CLM_ApsGetPlannerResGrpUtilSp";
