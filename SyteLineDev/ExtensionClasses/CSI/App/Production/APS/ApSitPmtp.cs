...
{
	public class ApSitPmtp : IApSitPmtp
	{
		readonly IApplicationDB appDB;
		
		public ApSitPmtp(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			decimal? PTcDomesticAmtCr = null)
		{
			...
			ListYesNoType _AppmtFactor = AppmtFactor;
			TaxCodeType _PAppmtdTaxCode = PAppmtdTaxCode;
			RowPointerType _AppmtdRowPointer = AppmtdRowPointer;
			PaymentNumberType _AppmtTHPaymentNumber = AppmtTHPaymentNumber;
			ListYesNoType _IsBuffer = IsBuffer;
			GenericDecimalType _PTcAmtCr = PTcAmtCr;
			GenericDecimalType _PTcDomesticAmtCr = PTcDomesticAmtCr;
			
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				
				cmd.CommandType = CommandType.StoredProcedure;
				cmd.CommandText = "ApSitPmtpSp";
				...
				appDB.AddCommandParameter(cmd, "AppmtFactor", _AppmtFactor, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PAppmtdTaxCode", _PAppmtdTaxCode, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "AppmtdRowPointer", _AppmtdRowPointer, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "AppmtTHPaymentNumber", _AppmtTHPaymentNumber, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "IsBuffer", _IsBuffer, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PTcAmtCr", _PTcAmtCr, ParameterDirection.InputOutput);
				appDB.AddCommandParameter(cmd, "PTcDomesticAmtCr", _PTcDomesticAmtCr, ParameterDirection.InputOutput);
				...
				Infobar = _Infobar;
				PTcAmtCr = _PTcAmtCr;
				PTcDomesticAmtCr = _PTcDomesticAmtCr;
				
				return (Severity, PCorpAmountPosted, PTTransDom, Infobar, PTcAmtCr, PTcDomesticAmtCr);
			}
		}
	}
}
