...
//CLASS NAME: ValidateJobmatlSeq.cs
...
{
	public class ValidateJobmatlSeq : IValidateJobmatlSeq
	{
		readonly IApplicationDB appDB;
		
		
		public ValidateJobmatlSeq(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string UM,
		string Item,
		...
		string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ValidateJobmatlSeqSp";
				...
				return (Severity, UM, Item, Infobar);
			}
		}
	}
}
