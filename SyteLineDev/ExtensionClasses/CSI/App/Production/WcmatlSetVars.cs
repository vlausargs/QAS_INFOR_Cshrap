...
{
	public interface IWcmatlSetVars
	{
		(int? ReturnCode, string Infobar) WcmatlSetVarsSp(string SET,
		string TWc,
		string TItem,
		string TWhse,
		string TLoc,
	...
	public class WcmatlSetVars : IWcmatlSetVars
	{
		readonly IApplicationDB appDB;
		
		public WcmatlSetVars(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) WcmatlSetVarsSp(string SET,
		string TWc,
		string TItem,
		string TWhse,
		string TLoc,
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WcmatlSetVarsSp";
