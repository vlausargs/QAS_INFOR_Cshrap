...
//CLASS NAME: CheckAltGroupExist.cs
...
{
	public interface ICheckAltGroupExist
	{
		(int? ReturnCode, string Infobar) CheckAltGroupExistSp(string Job,
		short? Suffix,
		int? OperNum,
		short? Sequence,
		short? AltGroup,
	...
	public class CheckAltGroupExist : ICheckAltGroupExist
	{
		readonly IApplicationDB appDB;
		
		public CheckAltGroupExist(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) CheckAltGroupExistSp(string Job,
		short? Suffix,
		int? OperNum,
		short? Sequence,
		short? AltGroup,
		...
		string Type = "C")
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CheckAltGroupExistSp";
