...
//CLASS NAME: ProcessJobMatlTrans.cs
...
{
	public interface IProcessJobMatlTrans
	{
		(int? ReturnCode, string Infobar) ProcessJobMatlTransSp(string Job,
		short? Suffix,
		int? OperNum,
		short? Sequence,
		byte? DeleteTmpSer = (byte)0,
		byte? Backflush = (byte)0,
		byte? ByProduct = (byte)0,
		string UM = null,
		string Item = null,
		...
		short? JobmatlRefLineSuf = null,
		short? JobmatlRefRelease = null,
		string Infobar = null,
	...
	public class ProcessJobMatlTrans : IProcessJobMatlTrans
	{
		readonly IApplicationDB appDB;
		
		public ProcessJobMatlTrans(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) ProcessJobMatlTransSp(string Job,
		short? Suffix,
		int? OperNum,
		short? Sequence,
		byte? DeleteTmpSer = (byte)0,
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProcessJobMatlTransSp";
