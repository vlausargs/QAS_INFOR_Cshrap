...
{
	public interface IPmfGetNextPn
	{
		(int? ReturnCode, string Key, string Infobar) PmfGetNextPnSp(string Context,
		                                                             string Prefix,
		                                                             int? KeyLength,
		                                                             string Key,
		                                                             string Infobar = null);
	...
	public class PmfGetNextPn : IPmfGetNextPn
	{
		readonly IApplicationDB appDB;
		
		public PmfGetNextPn(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Key, string Infobar) PmfGetNextPnSp(string Context,
		                                                                    string Prefix,
		                                                                    int? KeyLength,
		                                                                    string Key,
		                                                                    string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "PmfGetNextPnSp";
