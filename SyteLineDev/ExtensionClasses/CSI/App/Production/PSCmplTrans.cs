...
{
	public interface IPSCmplTrans
	{
		(int? ReturnCode, decimal? JobtranTransNum, byte? TCoby, string Infobar, string PromptMsg, string PromptButtons) PSCmplTransSp(string Item,
		decimal? Qty,
		DateTime? TransDate,
		string PsNum,
		string Employee,
	...
	public class PSCmplTrans : IPSCmplTrans
	{
		readonly IApplicationDB appDB;
		
		public PSCmplTrans(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, decimal? JobtranTransNum, byte? TCoby, string Infobar, string PromptMsg, string PromptButtons) PSCmplTransSp(string Item,
		decimal? Qty,
		DateTime? TransDate,
		string PsNum,
		string Employee,
