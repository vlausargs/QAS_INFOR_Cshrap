...
//CLASS NAME: RSQC_NextTemplate.cs
...
{
	public class RSQC_NextTemplate : IRSQC_NextTemplate
	{
		readonly IApplicationDB appDB;
		
		public RSQC_NextTemplate(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_NextTemplateSp";
