...
//CLASS NAME: RSQC_CreateEachTests.cs
...
{
	public class RSQC_CreateEachTests : IRSQC_CreateEachTests
	{
		readonly IApplicationDB appDB;
		
		
		public RSQC_CreateEachTests(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) RSQC_CreateEachTestsSp(int? i_rcvr,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CreateEachTestsSp";
