...
//CLASS NAME: RSQC_CreatePSReceiver.cs
...
{
	public class RSQC_CreatePSReceiver : IRSQC_CreatePSReceiver
	{
		readonly IApplicationDB appDB;
		
		
		public RSQC_CreatePSReceiver(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CreatePSReceiverSp";
