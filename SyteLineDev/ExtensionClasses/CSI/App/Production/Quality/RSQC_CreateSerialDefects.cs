...
//CLASS NAME: RSQC_CreateSerialDefects.cs
...
{
	public class RSQC_CreateSerialDefects : IRSQC_CreateSerialDefects
	{
		readonly IApplicationDB appDB;
		
		
		public RSQC_CreateSerialDefects(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) RSQC_CreateSerialDefectsSp(int? i_rcvr,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CreateSerialDefectsSp";
