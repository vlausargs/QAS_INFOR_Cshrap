...
//CLASS NAME: RSQC_CheckSupplierTO.cs
...
{
	public class RSQC_CheckSupplierTO : IRSQC_CheckSupplierTO
	{
		readonly IApplicationDB appDB;
		
		public RSQC_CheckSupplierTO(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CheckSupplierTOSp";
