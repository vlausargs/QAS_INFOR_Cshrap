...
//CLASS NAME: RSQC_CheckSupplierItems.cs
...
{
	public class RSQC_CheckSupplierItems : IRSQC_CheckSupplierItems
	{
		readonly IApplicationDB appDB;
		
		public RSQC_CheckSupplierItems(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CheckSupplierItemsSp";
