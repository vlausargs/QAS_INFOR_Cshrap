...
//CLASS NAME: RSQC_CheckSupplierItems2.cs
...
{
	public class RSQC_CheckSupplierItems2 : IRSQC_CheckSupplierItems2
	{
		readonly IApplicationDB appDB;
		
		public RSQC_CheckSupplierItems2(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CheckSupplierItemsSp2";
