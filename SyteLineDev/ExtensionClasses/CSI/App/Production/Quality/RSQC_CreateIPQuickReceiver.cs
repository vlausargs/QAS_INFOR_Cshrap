...
//CLASS NAME: RSQC_CreateIPQuickReceiver.cs
...
{
	public class RSQC_CreateIPQuickReceiver : IRSQC_CreateIPQuickReceiver
	{
		readonly IApplicationDB appDB;
		
		
		public RSQC_CreateIPQuickReceiver(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_CreateIPQuickReceiverSp";
