...
//CLASS NAME: RSQC_NextProcess.cs
...
{
	public class RSQC_NextProcess : IRSQC_NextProcess
	{
		readonly IApplicationDB appDB;
		
		public RSQC_NextProcess(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_NextProcessSp";
