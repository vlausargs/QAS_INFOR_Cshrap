...
//CLASS NAME: RSQC_GetXrefEstimateData.cs
...
{
	public class RSQC_GetXrefEstimateData : IRSQC_GetXrefEstimateData
	{
		readonly IApplicationDB appDB;
		
		
		public RSQC_GetXrefEstimateData(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RSQC_GetXrefEstimateDataSp";
