...
//CLASS NAME: ProjmatlTransactionSetVars.cs
...
{
	public class ProjmatlTransactionSetVars : IProjmatlTransactionSetVars
	{
		readonly IApplicationDB appDB;
		
		
		public ProjmatlTransactionSetVars(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string DocumentNum = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ProjmatlTransactionSetVarsSp";
