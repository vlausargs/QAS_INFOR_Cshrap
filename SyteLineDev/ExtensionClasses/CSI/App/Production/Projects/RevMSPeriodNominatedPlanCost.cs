...
//CLASS NAME: RevMSPeriodNominatedPlanCost.cs
...
{
	public class RevMSPeriodNominatedPlanCost : IRevMSPeriodNominatedPlanCost
	{
		readonly IApplicationDB appDB;
		
		public RevMSPeriodNominatedPlanCost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public decimal? RevMSPeriodNominatedPlanCostFn(
			string ProjNum,
			...
			int? Nominated)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[RevMSPeriodNominatedPlanCost](@ProjNum, @CurrentPeriodStart, @CurrentPeriodEnd, @Nominated)";
