...
//CLASS NAME: RevMSYearActualRevenue.cs
...
{
	public class RevMSYearActualRevenue : IRevMSYearActualRevenue
	{
		readonly IApplicationDB appDB;
		
		public RevMSYearActualRevenue(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public decimal? RevMSYearActualRevenueFn(
			string ProjNum,
			...
			DateTime? CurrentPeriodEnd)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[RevMSYearActualRevenue](@ProjNum, @CurrentPeriodStart, @CurrentPeriodEnd)";
