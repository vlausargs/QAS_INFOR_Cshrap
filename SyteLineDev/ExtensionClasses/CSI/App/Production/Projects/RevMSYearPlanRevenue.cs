...
//CLASS NAME: RevMSYearPlanRevenue.cs
...
{
	public class RevMSYearPlanRevenue : IRevMSYearPlanRevenue
	{
		readonly IApplicationDB appDB;
		
		public RevMSYearPlanRevenue(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public decimal? RevMSYearPlanRevenueFn(
			string ProjNum,
			...
			DateTime? CurrentPeriodEnd)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[RevMSYearPlanRevenue](@ProjNum, @CurrentPeriodStart, @CurrentPeriodEnd)";
