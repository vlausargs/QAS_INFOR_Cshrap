...
//CLASS NAME: InvMsSeqCheckReq.cs
...
{
	public interface IInvMsSeqCheckReq
	{
		int InvMsSeqCheckReqSp(string PProjNum,
		                       string PMsNum,
		                       int? PTaskNum,
	...
	public class InvMsSeqCheckReq : IInvMsSeqCheckReq
	{
		readonly IApplicationDB appDB;
		
		public InvMsSeqCheckReq(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		                              ...
		                              ref string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InvMsSeqCheckReqSp";
