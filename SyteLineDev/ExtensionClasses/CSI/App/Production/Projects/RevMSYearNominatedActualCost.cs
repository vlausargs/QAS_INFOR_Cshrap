...
//CLASS NAME: RevMSYearNominatedActualCost.cs
...
{
	public class RevMSYearNominatedActualCost : IRevMSYearNominatedActualCost
	{
		readonly IApplicationDB appDB;
		
		public RevMSYearNominatedActualCost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public decimal? RevMSYearNominatedActualCostFn(
			string ProjNum,
			...
			int? Nominated)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[RevMSYearNominatedActualCost](@ProjNum, @CurrentPeriodStart, @CurrentPeriodEnd, @Nominated)";
