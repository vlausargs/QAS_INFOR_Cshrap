...
{
	public interface IGetProjInitData
	{
		int GetProjInitDataSp(ref string RetCode,
		                      ref byte? AutoInvMs,
	...
	public class GetProjInitData : IGetProjInitData
	{
		readonly IApplicationDB appDB;
		
		public GetProjInitData(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		                             ...
		                             ref string TaxCode2Desc)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "GetProjInitDataSp";
