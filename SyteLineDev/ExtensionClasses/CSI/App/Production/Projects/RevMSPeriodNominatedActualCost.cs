...
//CLASS NAME: RevMSPeriodNominatedActualCost.cs
...
{
	public class RevMSPeriodNominatedActualCost : IRevMSPeriodNominatedActualCost
	{
		readonly IApplicationDB appDB;
		
		public RevMSPeriodNominatedActualCost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public decimal? RevMSPeriodNominatedActualCostFn(
			string ProjNum,
			...
			int? Nominated)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[RevMSPeriodNominatedActualCost](@ProjNum, @CurrentPeriodStart, @CurrentPeriodEnd, @Nominated)";
