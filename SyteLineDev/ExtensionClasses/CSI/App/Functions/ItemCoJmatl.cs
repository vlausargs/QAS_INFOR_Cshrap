...
{
	public class ItemCoJmatl : IItemCoJmatl
	{
		readonly IApplicationDB appDB;
		
		public ItemCoJmatl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string Infobar)
		{
			FlagNyType _PValidate = PValidate;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ItemCoJmatlSp";
				
				appDB.AddCommandParameter(cmd, "PValidate", _PValidate, ParameterDirection.Input);
