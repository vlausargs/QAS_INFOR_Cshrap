//PROJECT NAME: Data
//CLASS NAME: WBFSCanContRenPer.cs
...
{
	public class WBFSCanContRenPer : IWBFSCanContRenPer
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanContRenPer(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBFSCanContRenPerSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanContRenPerSp";
