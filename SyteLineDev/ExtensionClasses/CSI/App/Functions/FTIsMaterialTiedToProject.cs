//PROJECT NAME: Data
//CLASS NAME: FTIsMaterialTiedToProject.cs
...
{
	public class FTIsMaterialTiedToProject : IFTIsMaterialTiedToProject
	{
		readonly IApplicationDB appDB;
		
		public FTIsMaterialTiedToProject(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? FTIsMaterialTiedToProjectFn(
			string pJob,
			int? pSuffix,
			int? pOperNum,
			int? pSequence,
			...
			int? CheckJobStatus)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[FTIsMaterialTiedToProject](@pJob, @pSuffix, @pOperNum, @pSequence, @CheckIfSuppliedBySubJob, @CheckJobStatus)";
