//PROJECT NAME: Data
//CLASS NAME: ItemlifoBreakout.cs
...
{
	public class ItemlifoBreakout : IItemlifoBreakout
	{
		readonly IApplicationDB appDB;
		
		public ItemlifoBreakout(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			decimal? WhseQtyRemaining)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ItemlifoBreakoutSp";
