...
{
	public class NextLeadID : INextLeadID
	{
		readonly IApplicationDB appDB;
		
		public NextLeadID(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
