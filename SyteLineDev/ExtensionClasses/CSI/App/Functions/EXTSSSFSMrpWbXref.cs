//PROJECT NAME: Data
//CLASS NAME: EXTSSSFSMrpWbXref.cs
...
{
	public class EXTSSSFSMrpWbXref : IEXTSSSFSMrpWbXref
	{
		readonly IApplicationDB appDB;
		
		public EXTSSSFSMrpWbXref(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EXTSSSFSMrpWbXrefSp";
