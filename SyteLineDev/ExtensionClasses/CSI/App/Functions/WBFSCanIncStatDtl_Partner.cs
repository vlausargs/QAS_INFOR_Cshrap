//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncStatDtl_Partner.cs
...
{
	public class WBFSCanIncStatDtl_Partner : IWBFSCanIncStatDtl_Partner
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncStatDtl_Partner(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanIncStatDtl_PartnerSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncStatDtl_PartnerSp";
