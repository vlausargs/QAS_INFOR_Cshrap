//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncStatSubGetRecs.cs
...
{
	public class WBFSCanIncStatSubGetRecs : IWBFSCanIncStatSubGetRecs
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncStatSubGetRecs(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			string CrType) WBFSCanIncStatSubGetRecsSp(
			int? KPINum,
			DateTime? AsOfDate,
			string Parm1 = null,
			string Parm2 = null,
			...
			string CrType = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncStatSubGetRecsSp";
