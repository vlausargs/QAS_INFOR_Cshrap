//PROJECT NAME: Data
//CLASS NAME: PRtrxp1spPostChecks.cs
...
{
	public class PRtrxp1spPostChecks : IPRtrxp1spPostChecks
	{
		readonly IApplicationDB appDB;
		
		public PRtrxp1spPostChecks(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "PRtrxp1spPostChecksSp";
