//PROJECT NAME: Data
//CLASS NAME: EXTSSSFSXrefPrompt.cs
...
{
	public class EXTSSSFSXrefPrompt : IEXTSSSFSXrefPrompt
	{
		readonly IApplicationDB appDB;
		
		public EXTSSSFSXrefPrompt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EXTSSSFSXrefPromptSp";
