//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertInventory.cs
...
{
	public class EurDom3ConvertInventory : IEurDom3ConvertInventory
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertInventory(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertInventorySp";
