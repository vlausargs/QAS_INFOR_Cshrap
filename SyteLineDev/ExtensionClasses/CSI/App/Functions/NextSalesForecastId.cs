//PROJECT NAME: Data
//CLASS NAME: NextSalesForecastId.cs
...
{
	public class NextSalesForecastId : INextSalesForecastId
	{
		readonly IApplicationDB appDB;
		
		public NextSalesForecastId(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "NextSalesForecastIdSp";
