//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertVendors.cs
...
{
	public class EurDom3ConvertVendors : IEurDom3ConvertVendors
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertVendors(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertVendorsSp";
