//PROJECT NAME: Data
//CLASS NAME: NextContainerNum.cs
...
{
	public class NextContainerNum : INextContainerNum
	{
		readonly IApplicationDB appDB;
		
		public NextContainerNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "NextContainerNumSp";
