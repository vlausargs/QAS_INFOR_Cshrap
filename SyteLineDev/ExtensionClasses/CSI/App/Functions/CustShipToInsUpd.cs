//PROJECT NAME: Data
//CLASS NAME: CustShipToInsUpd.cs
...
{
	public class CustShipToInsUpd : ICustShipToInsUpd
	{
		readonly IApplicationDB appDB;
		
		public CustShipToInsUpd(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? CustShipToInsUpdSp(
			string CustNum,
			int? CustSeq,
			string Addr_1 = null,
			string Addr_2 = null,
			...
			string Stat = null)
		{
			...
			ListYesNoType _CustaddrAlreadyExists = CustaddrAlreadyExists;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CustShipToInsUpdSp";
				...
				appDB.AddCommandParameter(cmd, "CustaddrAlreadyExists", _CustaddrAlreadyExists, ParameterDirection.Input);
