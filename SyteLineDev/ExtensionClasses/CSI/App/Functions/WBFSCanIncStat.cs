...
{
	public class WBFSCanIncStat : IWBFSCanIncStat
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncStat(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBFSCanIncStatSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncStatSp";
