...
{
	public class Custcost : ICustcost
	{
		readonly IApplicationDB appDB;
		
		public Custcost(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			decimal? OActOtherCost)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				return (Severity, OActMatlCost, OActLaborCost, OActOvhCost, OActGaCost, OActOtherCost);
			}
		}
	}
}
