//PROJECT NAME: Data
//CLASS NAME: EXTSSSFSMrpChkXref.cs
...
{
	public class EXTSSSFSMrpChkXref : IEXTSSSFSMrpChkXref
	{
		readonly IApplicationDB appDB;
		
		public EXTSSSFSMrpChkXref(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string PErrMsg)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EXTSSSFSMrpChkXrefSp";
