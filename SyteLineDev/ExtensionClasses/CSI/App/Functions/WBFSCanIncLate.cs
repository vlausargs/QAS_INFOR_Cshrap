...
{
	public class WBFSCanIncLate : IWBFSCanIncLate
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncLate(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBFSCanIncLateSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncLateSp";
