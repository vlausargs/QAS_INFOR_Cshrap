//PROJECT NAME: Data
//CLASS NAME: WBFSCanContRevDtl.cs
...
{
	public class WBFSCanContRevDtl : IWBFSCanContRevDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanContRevDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanContRevDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanContRevDtlSp";
