//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertHr.cs
...
{
	public class EurDom3ConvertHr : IEurDom3ConvertHr
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertHr(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertHrSp";
