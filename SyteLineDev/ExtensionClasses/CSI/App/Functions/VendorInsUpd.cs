...
{
	public class VendorInsUpd : IVendorInsUpd
	{
		readonly IApplicationDB appDB;
		
		public VendorInsUpd(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? VendorInsUpdSp(
			string Vendnum,
			string Contact = null,
			string Phone = null,
			...
			string LongName = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "VendorInsUpdSp";
