//PROJECT NAME: Data
//CLASS NAME: WBFSCanSROStatDtl_Partner.cs
...
{
	public class WBFSCanSROStatDtl_Partner : IWBFSCanSROStatDtl_Partner
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanSROStatDtl_Partner(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanSROStatDtl_PartnerSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanSROStatDtl_PartnerSp";
