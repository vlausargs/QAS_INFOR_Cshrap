//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertFixedAssets.cs
...
{
	public class EurDom3ConvertFixedAssets : IEurDom3ConvertFixedAssets
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertFixedAssets(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertFixedAssetsSp";
