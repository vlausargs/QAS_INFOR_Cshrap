//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncDaysToResolveDtl.cs
...
{
	public class WBFSCanIncDaysToResolveDtl : IWBFSCanIncDaysToResolveDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncDaysToResolveDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanIncDaysToResolveDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncDaysToResolveDtlSp";
