//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncStatDtl.cs
...
{
	public class WBFSCanIncStatDtl : IWBFSCanIncStatDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncStatDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanIncStatDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncStatDtlSp";
