...
{
	public class NextArImportMap : INextArImportMap
	{
		readonly IApplicationDB appDB;
		
		public NextArImportMap(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "NextArImportMapSp";
