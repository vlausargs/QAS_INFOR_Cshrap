...
{
	public class FTPrepareAttend : IFTPrepareAttend
	{
		readonly IApplicationDB appDB;
		
		public FTPrepareAttend(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? FTPrepareAttendSp(
			string EmpNum = null,
			...
			Guid? SessionID = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "FTPrepareAttendSp";
