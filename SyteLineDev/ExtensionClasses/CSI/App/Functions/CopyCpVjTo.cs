...
{
	public class CopyCpVjTo : ICopyCpVjTo
	{
		readonly IApplicationDB appDB;
		
		public CopyCpVjTo(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			int? P_Suffix_F = 0)
		{
			...
			IntType _BomImportBuilder = BomImportBuilder;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				appDB.AddCommandParameter(cmd, "BomImportBuilder", _BomImportBuilder, ParameterDirection.Input);
