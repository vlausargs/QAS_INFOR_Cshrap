//PROJECT NAME: Data
//CLASS NAME: NextCompetitorID.cs
...
{
	public class NextCompetitorID : INextCompetitorID
	{
		readonly IApplicationDB appDB;
		
		public NextCompetitorID(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			string Key,
			string Infobar) NextCompetitorIDSp(
			string Context,
			string Prefix,
			int? KeyLength,
			string Key,
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "NextCompetitorIDSp";
