//PROJECT NAME: Data
//CLASS NAME: WBFSCanContRenPerDtl.cs
...
{
	public class WBFSCanContRenPerDtl : IWBFSCanContRenPerDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanContRenPerDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanContRenPerDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanContRenPerDtlSp";
