//PROJECT NAME: Data
//CLASS NAME: CLM_InvalidDueDateExternalSiteOrders.cs
...
{
	public class CLM_InvalidDueDateExternalSiteOrders : ICLM_InvalidDueDateExternalSiteOrders
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_InvalidDueDateExternalSiteOrders(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CLM_InvalidDueDateExternalSiteOrdersSp(
			string OrderType,
			string Status,
			...
			string OrigSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CLM_InvalidDueDateExternalSiteOrdersSp";
