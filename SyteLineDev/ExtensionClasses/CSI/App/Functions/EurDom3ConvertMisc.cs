//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertMisc.cs
...
{
	public class EurDom3ConvertMisc : IEurDom3ConvertMisc
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertMisc(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertMiscSp";
