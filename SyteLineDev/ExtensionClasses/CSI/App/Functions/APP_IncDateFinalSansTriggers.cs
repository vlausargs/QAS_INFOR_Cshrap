//PROJECT NAME: Data
//CLASS NAME: APP_IncDateFinalSansTriggers.cs
...
{
	public class APP_IncDateFinalSansTriggers : IAPP_IncDateFinalSansTriggers
	{
		readonly IApplicationDB appDB;
		
		public APP_IncDateFinalSansTriggers(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string InfoBar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "APP_IncDateFinalSansTriggersSp";
