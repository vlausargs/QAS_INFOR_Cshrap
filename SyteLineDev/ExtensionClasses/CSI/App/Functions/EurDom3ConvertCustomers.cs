//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertCustomers.cs
...
{
	public class EurDom3ConvertCustomers : IEurDom3ConvertCustomers
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertCustomers(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertCustomersSp";
