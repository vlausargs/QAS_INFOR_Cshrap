...
{
	public class FTPrepareSRO : IFTPrepareSRO
	{
		readonly IApplicationDB appDB;
		
		public FTPrepareSRO(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? FTPrepareSROSp(
			string EmpNum = null,
			...
			Guid? SessionID = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "FTPrepareSROSp";
