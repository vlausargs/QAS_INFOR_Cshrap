//PROJECT NAME: Data
//CLASS NAME: WBFSCanContRenPerDtl_Family.cs
...
{
	public class WBFSCanContRenPerDtl_Family : IWBFSCanContRenPerDtl_Family
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanContRenPerDtl_Family(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanContRenPerDtl_FamilySp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanContRenPerDtl_FamilySp";
