//PROJECT NAME: Data
//CLASS NAME: EXTSSSFSTransferOrderReceive.cs
...
{
	public class EXTSSSFSTransferOrderReceive : IEXTSSSFSTransferOrderReceive
	{
		readonly IApplicationDB appDB;
		
		public EXTSSSFSTransferOrderReceive(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string ImportDocId = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EXTSSSFSTransferOrderReceiveSp";
