//PROJECT NAME: Data
//CLASS NAME: FTPrepareProject.cs
...
{
	public class FTPrepareProject : IFTPrepareProject
	{
		readonly IApplicationDB appDB;
		
		public FTPrepareProject(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? FTPrepareProjectSp(
			string EmpNum = null,
			...
			Guid? SessionID = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "FTPrepareProjectSp";
