//PROJECT NAME: Data
//CLASS NAME: EurDom3ConvertJobs.cs
...
{
	public class EurDom3ConvertJobs : IEurDom3ConvertJobs
	{
		readonly IApplicationDB appDB;
		
		public EurDom3ConvertJobs(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EurDom3ConvertJobsSp";
