//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncLateDtl.cs
...
{
	public class WBFSCanIncLateDtl : IWBFSCanIncLateDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncLateDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanIncLateDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncLateDtlSp";
