...
{
	public class EdiOutObDriver : IEdiOutObDriver
	{
		readonly IApplicationDB appDB;
		
		public EdiOutObDriver(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "EdiOutObDriverSp";
