//PROJECT NAME: Data
//CLASS NAME: WBFSCanIncDaysToResolve.cs
...
{
	public class WBFSCanIncDaysToResolve : IWBFSCanIncDaysToResolve
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanIncDaysToResolve(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBFSCanIncDaysToResolveSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanIncDaysToResolveSp";
