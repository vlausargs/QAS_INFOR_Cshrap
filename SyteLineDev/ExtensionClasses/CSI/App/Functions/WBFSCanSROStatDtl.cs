//PROJECT NAME: Data
//CLASS NAME: WBFSCanSROStatDtl.cs
...
{
	public class WBFSCanSROStatDtl : IWBFSCanSROStatDtl
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanSROStatDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBFSCanSROStatDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanSROStatDtlSp";
