//PROJECT NAME: Data
//CLASS NAME: GlbankChangeDirectDebitStatus.cs
...
{
	public class GlbankChangeDirectDebitStatus : IGlbankChangeDirectDebitStatus
	{
		readonly IApplicationDB appDB;
		
		public GlbankChangeDirectDebitStatus(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			DateTime? CheckDate = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "GlbankChangeDirectDebitStatusSp";
