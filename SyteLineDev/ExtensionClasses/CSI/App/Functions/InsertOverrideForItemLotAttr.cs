//PROJECT NAME: Data
//CLASS NAME: InsertOverrideForItemLotAttr.cs
...
{
	public class InsertOverrideForItemLotAttr : IInsertOverrideForItemLotAttr
	{
		readonly IApplicationDB appDB;
		
		public InsertOverrideForItemLotAttr(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InsertOverrideForItemLotAttrSp";
