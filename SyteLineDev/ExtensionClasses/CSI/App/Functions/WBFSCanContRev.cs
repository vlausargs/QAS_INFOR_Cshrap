...
{
	public class WBFSCanContRev : IWBFSCanContRev
	{
		readonly IApplicationDB appDB;
		
		public WBFSCanContRev(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBFSCanContRevSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBFSCanContRevSp";
