//PROJECT NAME: Data
//CLASS NAME: InventoryBalanceByPeriod.cs
...
{
	public class InventoryBalanceByPeriod : IInventoryBalanceByPeriod
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public InventoryBalanceByPeriod(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) InventoryBalanceByPeriodSp(
			...
			int? DisplayHeader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "InventoryBalanceByPeriodSp";
