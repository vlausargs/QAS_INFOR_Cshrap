...
//CLASS NAME: CLM_ESBEUSalesLine.cs
...
{
	public class CLM_ESBEUSalesLine : ICLM_ESBEUSalesLine
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_ESBEUSalesLine(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CLM_ESBEUSalesLineSp(string SiteGroup,
		int? CalendarQuarter,
		...
		string EndProcessInd)
		{
			...
			IntType _CalendarQuarter = CalendarQuarter;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CLM_ESBEUSalesLineSp";
				
				appDB.AddCommandParameter(cmd, "SiteGroup", _SiteGroup, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "CalendarQuarter", _CalendarQuarter, ParameterDirection.Input);
