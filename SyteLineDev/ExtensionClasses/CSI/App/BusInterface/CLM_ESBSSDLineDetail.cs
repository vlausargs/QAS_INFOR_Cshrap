...
//CLASS NAME: CLM_ESBSSDLineDetail.cs
...
{
	public class CLM_ESBSSDLineDetail : ICLM_ESBSSDLineDetail
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_ESBSSDLineDetail(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CLM_ESBSSDLineDetailSp(string TransIndicator,
		string RefType,
		...
		string DeclarationID)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CLM_ESBSSDLineDetailSp";
