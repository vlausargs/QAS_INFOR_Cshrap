...
//CLASS NAME: LoadESBBillToPartyMaster.cs
...
{
	public interface ILoadESBBillToPartyMaster
	{
		int LoadESBBillToPartyMasterSp(string DerBODID,
	...
	public class LoadESBBillToPartyMaster : ILoadESBBillToPartyMaster
	{
		readonly IApplicationDB appDB;
		
		public LoadESBBillToPartyMaster(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		                                      ...
		                                      ref string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "LoadESBBillToPartyMasterSp";
