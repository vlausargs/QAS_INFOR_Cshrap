...
//CLASS NAME: CLM_ESBReplDocumentExt.cs
...
{
	public class CLM_ESBReplDocumentExt : ICLM_ESBReplDocumentExt
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CLM_ESBReplDocumentExt(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode, string InfoBar) CLM_ESBReplDocumentExtSp(string BODNoun,
		string BODVerb,
		string DocumentID,
		string FilterString,
		...
		string InfoBar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CLM_ESBReplDocumentExtSp";
