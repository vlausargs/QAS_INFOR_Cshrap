...
//CLASS NAME: LoadESBInventoryCountLine.cs
...
{
	public class LoadESBInventoryCountLine : ILoadESBInventoryCountLine
	{
		readonly IApplicationDB appDB;
		
		
		public LoadESBInventoryCountLine(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string InfoBar) LoadESBInventoryCountLineSP(string BODNOUN,
		string DocumentID,
		string Item,
		string Warehouse,
		...
		string InfoBar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "LoadESBInventoryCountLineSP";
