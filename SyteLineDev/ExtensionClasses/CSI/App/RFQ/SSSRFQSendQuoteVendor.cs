//PROJECT NAME: RFQ
//CLASS NAME: SSSRFQSendQuoteVendor.cs
...
namespace CSI.RFQ
{
	public class SSSRFQSendQuoteVendor : ISSSRFQSendQuoteVendor
	{
		readonly IApplicationDB appDB;
		
		public SSSRFQSendQuoteVendor(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSRFQSendQuoteVendorSp";
