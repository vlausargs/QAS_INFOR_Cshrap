//PROJECT NAME: RFQ
//CLASS NAME: SSSRFQNextRFQNum.cs
...
namespace CSI.RFQ
{
	public class SSSRFQNextRFQNum : ISSSRFQNextRFQNum
	{
		readonly IApplicationDB appDB;
		
		public SSSRFQNextRFQNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSRFQNextRFQNumSp";
