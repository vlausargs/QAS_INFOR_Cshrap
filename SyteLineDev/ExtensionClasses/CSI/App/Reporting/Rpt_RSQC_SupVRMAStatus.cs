...
//CLASS NAME: Rpt_RSQC_SupVRMAStatus.cs
...
{
	public class Rpt_RSQC_SupVRMAStatus : IRpt_RSQC_SupVRMAStatus
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_SupVRMAStatus(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_SupVRMAStatusSp(
			string begitem = null,
			string enditem = null,
			string begvend = null,
			string endvend = null,
			...
			int? displayheader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_SupVRMAStatusSp";
