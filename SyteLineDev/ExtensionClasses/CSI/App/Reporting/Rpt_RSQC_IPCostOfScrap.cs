...
//CLASS NAME: Rpt_RSQC_IPCostOfScrap.cs
...
{
	public class Rpt_RSQC_IPCostOfScrap : IRpt_RSQC_IPCostOfScrap
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_IPCostOfScrap(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_IPCostOfScrapSp(
			string BegItem = null,
			string EndItem = null,
			string begjob = null,
			string endjob = null,
			...
			int? DisplayHeader = 0)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_IPCostOfScrapSp";
