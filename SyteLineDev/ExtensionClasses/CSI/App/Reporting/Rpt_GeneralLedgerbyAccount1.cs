...
//CLASS NAME: Rpt_GeneralLedgerbyAccount1.cs
...
{
	public class Rpt_GeneralLedgerbyAccount1 : IRpt_GeneralLedgerbyAccount1
	{
		readonly IApplicationDB appDB;
		
		public Rpt_GeneralLedgerbyAccount1(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? Rpt_GeneralLedgerbyAccount1Sp(
			...
			int? SeparateDrCrAmounts = 0)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_GeneralLedgerbyAccount1Sp";
