...
//CLASS NAME: CHSRpt_NotBucket.cs
...
{
	public interface ICHSRpt_NotBucket
	{
		(ICollectionLoadResponse Data, int? ReturnCode) CHSRpt_NotBucketSp(decimal? BookKey,
		string BookType,
		string BeginAccount,
		string EndAccount,
		string BegUnit1,
	...
	public class CHSRpt_NotBucket : ICHSRpt_NotBucket
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public CHSRpt_NotBucket(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) CHSRpt_NotBucketSp(decimal? BookKey,
		string BookType,
		string BeginAccount,
		string EndAccount,
		string BegUnit1,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CHSRpt_NotBucketSp";
