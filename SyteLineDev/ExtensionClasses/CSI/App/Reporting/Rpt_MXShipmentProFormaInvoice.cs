...
//CLASS NAME: Rpt_MXShipmentProFormaInvoice.cs
...
{
	public class Rpt_MXShipmentProFormaInvoice : IRpt_MXShipmentProFormaInvoice
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_MXShipmentProFormaInvoice(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_MXShipmentProFormaInvoiceSp(
			...
			int? Print = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_MXShipmentProFormaInvoiceSp";
				...
				appDB.AddCommandParameter(cmd, "Print", _Print, ParameterDirection.Input);
