...
//CLASS NAME: Rpt_RSQC_IPResultsWorksheet.cs
...
{
	public class Rpt_RSQC_IPResultsWorksheet : IRpt_RSQC_IPResultsWorksheet
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_IPResultsWorksheet(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_IPResultsWorksheetSp(
			string begitem = null,
			string enditem = null,
			int? begopernum = null,
			int? endopernum = null,
			...
			int? PrintExternal = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_IPResultsWorksheetSp";
