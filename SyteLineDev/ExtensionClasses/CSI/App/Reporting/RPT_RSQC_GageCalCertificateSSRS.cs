...
//CLASS NAME: RPT_RSQC_GageCalCertificateSSRS.cs
...
{
	public class RPT_RSQC_GageCalCertificateSSRS : IRPT_RSQC_GageCalCertificateSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public RPT_RSQC_GageCalCertificateSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) RPT_RSQC_GageCalCertificateSSRSSp(string BegGage = null,
		string EndGage = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RPT_RSQC_GageCalCertificateSSRSSp";
