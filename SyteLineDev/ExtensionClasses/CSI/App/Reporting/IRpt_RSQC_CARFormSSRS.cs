...
//CLASS NAME: IRpt_RSQC_CARFormSSRS.cs
...
{
	public interface IRpt_RSQC_CARFormSSRS
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_CARFormSSRSSp(string begcar = null,
		string endcar = null,
		string begitem = null,
		string enditem = null,
