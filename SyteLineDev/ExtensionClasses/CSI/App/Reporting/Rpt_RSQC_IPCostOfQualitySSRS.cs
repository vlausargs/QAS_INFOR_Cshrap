...
//CLASS NAME: Rpt_RSQC_IPCostOfQualitySSRS.cs
...
{
	public class Rpt_RSQC_IPCostOfQualitySSRS : IRpt_RSQC_IPCostOfQualitySSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_IPCostOfQualitySSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_IPCostOfQualitySSRSSp(string begitem = null,
		string enditem = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_IPCostOfQualitySSRSSp";
