...
{
	public class Rpt_ItemGenMix : IRpt_ItemGenMix
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ItemGenMix(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode, string Infobar) Rpt_ItemGenMixSp(string PProdMix,
		int? PNetChange = 0,
		...
		string BGUser = null)
		{
			...
			ListYesNoType _PNetChange = PNetChange;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ItemGenMixSp";
				
				appDB.AddCommandParameter(cmd, "PProdMix", _PProdMix, ParameterDirection.Input);
				appDB.AddCommandParameter(cmd, "PNetChange", _PNetChange, ParameterDirection.Input);
