...
//CLASS NAME: Rpt_ProjectedItemCompletionsbyResourceMRPAPS.cs
...
{
	public class Rpt_ProjectedItemCompletionsbyResourceMRPAPS : IRpt_ProjectedItemCompletionsbyResourceMRPAPS
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ProjectedItemCompletionsbyResourceMRPAPS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_ProjectedItemCompletionsbyResourceMRPAPSSp(string ResourceStarting = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ProjectedItemCompletionsbyResourceMRPAPSSp";
