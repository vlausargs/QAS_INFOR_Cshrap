...
{
	public class Rpt_ProjRetInv : IRpt_ProjRetInv
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ProjRetInv(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_ProjRetInvSp(string StartingProjNum = null,
		...
		string pSite = null)
		{
			...
			FlagNyType _PrintDiscountAmt = PrintDiscountAmt;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ProjRetInvSp";
