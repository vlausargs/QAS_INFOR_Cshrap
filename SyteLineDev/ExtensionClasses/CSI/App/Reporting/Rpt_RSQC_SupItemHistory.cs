...
//CLASS NAME: Rpt_RSQC_SupItemHistory.cs
...
{
	public class Rpt_RSQC_SupItemHistory : IRpt_RSQC_SupItemHistory
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_SupItemHistory(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_SupItemHistorySp(
			string begitem = null,
			string enditem = null,
			string begvend = null,
			string endvend = null,
			...
			int? displayheader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_SupItemHistorySp";
