...
//CLASS NAME: SSSFSRpt_AcmTrans.cs
...
{
	public class SSSFSRpt_AcmTrans : ISSSFSRpt_AcmTrans
	{
		IApplicationDB appDB;
		IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public SSSFSRpt_AcmTrans(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) SSSFSRpt_AcmTransSp(string ExOptBegCust_num = null,
		...
		string ReportOption = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSFSRpt_AcmTransSp";
