...
//CLASS NAME: Rpt_MultiFSBJournalTransaction.cs
...
{
	public class Rpt_MultiFSBJournalTransaction : IRpt_MultiFSBJournalTransaction
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_MultiFSBJournalTransaction(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_MultiFSBJournalTransactionSp(string CurId = null,
		string FSBName = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_MultiFSBJournalTransactionSp";
