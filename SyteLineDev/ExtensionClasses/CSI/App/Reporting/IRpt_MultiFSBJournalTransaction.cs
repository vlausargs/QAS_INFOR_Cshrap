...
//CLASS NAME: IRpt_MultiFSBJournalTransaction.cs
...
{
	public interface IRpt_MultiFSBJournalTransaction
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_MultiFSBJournalTransactionSp(string CurId = null,
		string FSBName = null,
