...
//CLASS NAME: Rpt_GeneralLedgerTransactionS03aDNReport.cs
...
{
	public class Rpt_GeneralLedgerTransactionS03aDNReport : IRpt_GeneralLedgerTransactionS03aDNReport
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_GeneralLedgerTransactionS03aDNReport(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_GeneralLedgerTransactionS03aDNReportSp(decimal? ExOptStartingTrans = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_GeneralLedgerTransactionS03aDNReportSp";
