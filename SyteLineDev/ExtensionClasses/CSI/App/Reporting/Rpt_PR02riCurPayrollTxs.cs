...
//CLASS NAME: Rpt_PR02riCurPayrollTxs.cs
...
{
	public class Rpt_PR02riCurPayrollTxs : IRpt_PR02riCurPayrollTxs
	{
		...
		public Rpt_PR02riCurPayrollTxs(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_PR02riCurPayrollTxsSp(string pSessionIDChar = null,
		...
		string BGUser = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_PR02riCurPayrollTxsSp";
