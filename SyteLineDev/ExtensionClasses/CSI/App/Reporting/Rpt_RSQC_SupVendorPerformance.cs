...
//CLASS NAME: Rpt_RSQC_SupVendorPerformance.cs
...
{
	public class Rpt_RSQC_SupVendorPerformance : IRpt_RSQC_SupVendorPerformance
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_SupVendorPerformance(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_SupVendorPerformanceSp(
			string begvend = null,
			string endvend = null,
			...
			int? displayheader = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_SupVendorPerformanceSp";
