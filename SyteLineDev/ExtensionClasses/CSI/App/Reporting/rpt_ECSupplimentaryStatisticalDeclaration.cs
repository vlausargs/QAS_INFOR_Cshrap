...
//CLASS NAME: rpt_ECSupplimentaryStatisticalDeclaration.cs
...
{
	public class rpt_ECSupplimentaryStatisticalDeclaration : Irpt_ECSupplimentaryStatisticalDeclaration
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public rpt_ECSupplimentaryStatisticalDeclaration(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) rpt_ECSupplimentaryStatisticalDeclarationSp(DateTime? PeriodStarting = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "rpt_ECSupplimentaryStatisticalDeclarationSp";
