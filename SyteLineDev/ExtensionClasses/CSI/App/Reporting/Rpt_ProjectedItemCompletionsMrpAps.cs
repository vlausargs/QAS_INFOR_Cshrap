...
//CLASS NAME: Rpt_ProjectedItemCompletionsMrpAps.cs
...
{
	public class Rpt_ProjectedItemCompletionsMrpAps : IRpt_ProjectedItemCompletionsMrpAps
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ProjectedItemCompletionsMrpAps(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_ProjectedItemCompletionsMrpApsSp(string PlannerCodeStarting = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ProjectedItemCompletionsMrpApsSp";
