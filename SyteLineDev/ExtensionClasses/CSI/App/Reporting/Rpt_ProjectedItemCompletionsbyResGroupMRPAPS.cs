...
//CLASS NAME: Rpt_ProjectedItemCompletionsbyResGroupMRPAPS.cs
...
{
	public class Rpt_ProjectedItemCompletionsbyResGroupMRPAPS : IRpt_ProjectedItemCompletionsbyResGroupMRPAPS
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ProjectedItemCompletionsbyResGroupMRPAPS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_ProjectedItemCompletionsbyResGroupMRPAPSSp(string StartingResource = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ProjectedItemCompletionsbyResGroupMRPAPSSp";
