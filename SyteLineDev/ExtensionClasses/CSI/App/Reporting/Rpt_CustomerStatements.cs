...
//CLASS NAME: Rpt_CustomerStatements.cs
...
{
	public class Rpt_CustomerStatements : IRpt_CustomerStatements
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_CustomerStatements(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_CustomerStatementsSp(DateTime? StatementDate = null,
		int? ShowActive = null,
		...
		string BGUser = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_CustomerStatementsSp";
