...
//CLASS NAME: IRpt_POFundsCommitted.cs
...
{
	public interface IRpt_POFundsCommitted
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_POFundsCommittedSp(string pPoType = null,
