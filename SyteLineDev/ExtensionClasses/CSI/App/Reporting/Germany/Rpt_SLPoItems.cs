...
{
    public class Rpt_SLPoItems : IRpt_SLPoItems
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;

        public Rpt_SLPoItems(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
        {
            this.appDB = appDB;
        ...
        {
            return Rpt_SLPoItemsSp(TransDateBeg, TransDateEnd, SiteID);
        }
        public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_SLPoItemsSp(
            ...
            string SiteID)
        {
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "Rpt_SLPoItemsSp";
