...
{
    public class Rpt_SLCustomers : IRpt_SLCustomers
    {
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;

        public Rpt_SLCustomers(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
        {
            this.appDB = appDB;
        ...
        {
            return Rpt_SLCustomersSp(TransDateBeg, TransDateEnd, SiteID);
        }
        public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_SLCustomersSp(
            ...
            string SiteID)
        {
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "Rpt_SLCustomersSp";
