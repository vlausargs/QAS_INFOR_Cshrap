...
//CLASS NAME: Rpt_RSQC_SupVRMAStatusSSRS.cs
...
{
	public class Rpt_RSQC_SupVRMAStatusSSRS : IRpt_RSQC_SupVRMAStatusSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_SupVRMAStatusSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_SupVRMAStatusSSRSSp(string begitem = null,
		string enditem = null,
		string begvend = null,
		string endvend = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_SupVRMAStatusSSRSSp";
