...
//CLASS NAME: RPT_RSQC_SPCSSRS.cs
...
{
	public class RPT_RSQC_SPCSSRS : IRPT_RSQC_SPCSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public RPT_RSQC_SPCSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) RPT_RSQC_SPCSSRSSp(string i_item,
		string i_ref_type,
		string i_entity,
		int? i_lookback,
		int? i_showdetail,
		string psite)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RPT_RSQC_SPCSSRSSp";
