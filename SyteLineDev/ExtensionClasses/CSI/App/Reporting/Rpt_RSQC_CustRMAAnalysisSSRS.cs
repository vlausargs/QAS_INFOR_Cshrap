...
//CLASS NAME: Rpt_RSQC_CustRMAAnalysisSSRS.cs
...
{
	public class Rpt_RSQC_CustRMAAnalysisSSRS : IRpt_RSQC_CustRMAAnalysisSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_CustRMAAnalysisSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_CustRMAAnalysisSSRSSp(string begitem = null,
		string enditem = null,
		string begcust = null,
		string endcust = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_CustRMAAnalysisSSRSSp";
