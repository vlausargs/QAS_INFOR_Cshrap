...
//CLASS NAME: WBCanCoitemPastDue.cs
...
{
	public class WBCanCoitemPastDue : IWBCanCoitemPastDue
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoitemPastDue(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanCoitemPastDueSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoitemPastDueSp";
