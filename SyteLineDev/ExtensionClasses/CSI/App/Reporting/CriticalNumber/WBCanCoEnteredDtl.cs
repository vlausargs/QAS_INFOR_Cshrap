...
//CLASS NAME: WBCanCoEnteredDtl.cs
...
{
	public class WBCanCoEnteredDtl : IWBCanCoEnteredDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoEnteredDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanCoEnteredDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoEnteredDtlSp";
