...
//CLASS NAME: WBCanSROHoursDtl.cs
...
{
	public class WBCanSROHoursDtl : IWBCanSROHoursDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanSROHoursDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanSROHoursDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanSROHoursDtlSp";
