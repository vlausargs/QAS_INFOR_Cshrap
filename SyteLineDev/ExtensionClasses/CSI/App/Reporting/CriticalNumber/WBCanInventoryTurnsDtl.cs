...
//CLASS NAME: WBCanInventoryTurnsDtl.cs
...
{
	public class WBCanInventoryTurnsDtl : IWBCanInventoryTurnsDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInventoryTurnsDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInventoryTurnsDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInventoryTurnsDtlSp";
