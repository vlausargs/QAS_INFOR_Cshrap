...
//CLASS NAME: WBCanJobScrapVal.cs
...
{
	public class WBCanJobScrapVal : IWBCanJobScrapVal
	{
		readonly IApplicationDB appDB;
		
		public WBCanJobScrapVal(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanJobScrapValSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanJobScrapValSp";
