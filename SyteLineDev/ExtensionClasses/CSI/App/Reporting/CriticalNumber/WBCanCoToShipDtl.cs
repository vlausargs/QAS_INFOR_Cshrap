...
//CLASS NAME: WBCanCoToShipDtl.cs
...
{
	public class WBCanCoToShipDtl : IWBCanCoToShipDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoToShipDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanCoToShipDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoToShipDtlSp";
