...
//CLASS NAME: WBCanInventoryTurns.cs
...
{
	public class WBCanInventoryTurns : IWBCanInventoryTurns
	{
		readonly IApplicationDB appDB;
		
		public WBCanInventoryTurns(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanInventoryTurnsSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInventoryTurnsSp";
