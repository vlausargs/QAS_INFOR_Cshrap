...
{
	public class WBCanPoRcptDtl : IWBCanPoRcptDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoRcptDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanPoRcptDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoRcptDtlSp";
