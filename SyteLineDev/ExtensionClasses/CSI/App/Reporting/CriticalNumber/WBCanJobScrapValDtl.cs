...
//CLASS NAME: WBCanJobScrapValDtl.cs
...
{
	public class WBCanJobScrapValDtl : IWBCanJobScrapValDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanJobScrapValDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanJobScrapValDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanJobScrapValDtlSp";
