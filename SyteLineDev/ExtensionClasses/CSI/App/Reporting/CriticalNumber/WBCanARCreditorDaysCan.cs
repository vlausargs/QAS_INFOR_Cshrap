...
//CLASS NAME: WBCanARCreditorDaysCan.cs
...
{
	public class WBCanARCreditorDaysCan : IWBCanARCreditorDaysCan
	{
		readonly IApplicationDB appDB;
		
		public WBCanARCreditorDaysCan(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanARCreditorDaysCanSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanARCreditorDaysCanSp";
