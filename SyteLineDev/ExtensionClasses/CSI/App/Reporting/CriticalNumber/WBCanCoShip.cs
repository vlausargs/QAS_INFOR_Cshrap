...
{
	public class WBCanCoShip : IWBCanCoShip
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoShip(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanCoShipSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
