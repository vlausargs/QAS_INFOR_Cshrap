...
{
	public class WBCanArAgingDtl : IWBCanArAgingDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanArAgingDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanArAgingDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanArAgingDtlSp";
