...
{
	public class WBCanEstBookDtl : IWBCanEstBookDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanEstBookDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanEstBookDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanEstBookDtlSp";
