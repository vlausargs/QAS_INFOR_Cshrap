...
//CLASS NAME: WBCanCoitemPastDueDetails.cs
...
{
	public class WBCanCoitemPastDueDetails : IWBCanCoitemPastDueDetails
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoitemPastDueDetails(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanCoitemPastDueDetailsSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoitemPastDueDetailsSp";
