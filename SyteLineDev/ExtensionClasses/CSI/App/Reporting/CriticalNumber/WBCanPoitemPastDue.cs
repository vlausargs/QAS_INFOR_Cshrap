...
//CLASS NAME: WBCanPoitemPastDue.cs
...
{
	public class WBCanPoitemPastDue : IWBCanPoitemPastDue
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoitemPastDue(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanPoitemPastDueSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoitemPastDueSp";
