...
//CLASS NAME: WBCanInvPctCycCnt.cs
...
{
	public class WBCanInvPctCycCnt : IWBCanInvPctCycCnt
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvPctCycCnt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanInvPctCycCntSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvPctCycCntSp";
