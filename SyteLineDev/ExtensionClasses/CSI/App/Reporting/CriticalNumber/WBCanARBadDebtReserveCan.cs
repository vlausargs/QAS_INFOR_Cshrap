...
//CLASS NAME: WBCanARBadDebtReserveCan.cs
...
{
	public class WBCanARBadDebtReserveCan : IWBCanARBadDebtReserveCan
	{
		readonly IApplicationDB appDB;
		
		public WBCanARBadDebtReserveCan(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanARBadDebtReserveCanSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanARBadDebtReserveCanSp";
