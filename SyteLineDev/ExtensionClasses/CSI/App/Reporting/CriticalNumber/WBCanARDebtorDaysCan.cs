...
//CLASS NAME: WBCanARDebtorDaysCan.cs
...
{
	public class WBCanARDebtorDaysCan : IWBCanARDebtorDaysCan
	{
		readonly IApplicationDB appDB;
		
		public WBCanARDebtorDaysCan(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanARDebtorDaysCanSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanARDebtorDaysCanSp";
