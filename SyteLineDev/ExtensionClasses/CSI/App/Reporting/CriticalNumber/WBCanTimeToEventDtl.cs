...
//CLASS NAME: WBCanTimeToEventDtl.cs
...
{
	public class WBCanTimeToEventDtl : IWBCanTimeToEventDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanTimeToEventDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanTimeToEventDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanTimeToEventDtlSp";
