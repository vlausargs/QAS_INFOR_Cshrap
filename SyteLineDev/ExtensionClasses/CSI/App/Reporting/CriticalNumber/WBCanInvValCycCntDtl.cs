...
//CLASS NAME: WBCanInvValCycCntDtl.cs
...
{
	public class WBCanInvValCycCntDtl : IWBCanInvValCycCntDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvValCycCntDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInvValCycCntDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvValCycCntDtlSp";
