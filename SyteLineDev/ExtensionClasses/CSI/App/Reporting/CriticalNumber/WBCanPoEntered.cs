...
{
	public class WBCanPoEntered : IWBCanPoEntered
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoEntered(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanPoEnteredSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoEnteredSp";
