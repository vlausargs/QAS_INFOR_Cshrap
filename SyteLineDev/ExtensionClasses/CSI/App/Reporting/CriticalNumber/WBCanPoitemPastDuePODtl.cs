...
//CLASS NAME: WBCanPoitemPastDuePODtl.cs
...
{
	public class WBCanPoitemPastDuePODtl : IWBCanPoitemPastDuePODtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoitemPastDuePODtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanPoitemPastDuePODtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoitemPastDuePODtlSp";
