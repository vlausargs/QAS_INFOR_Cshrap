...
{
	public class WBCanInvVal : IWBCanInvVal
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvVal(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanInvValSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
