...
//CLASS NAME: WBCanInventoryTurnsDaysDtl.cs
...
{
	public class WBCanInventoryTurnsDaysDtl : IWBCanInventoryTurnsDaysDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInventoryTurnsDaysDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInventoryTurnsDaysDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInventoryTurnsDaysDtlSp";
