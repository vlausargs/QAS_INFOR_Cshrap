...
//CLASS NAME: WBCanInventoryTurnsDays.cs
...
{
	public class WBCanInventoryTurnsDays : IWBCanInventoryTurnsDays
	{
		readonly IApplicationDB appDB;
		
		public WBCanInventoryTurnsDays(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanInventoryTurnsDaysSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInventoryTurnsDaysSp";
