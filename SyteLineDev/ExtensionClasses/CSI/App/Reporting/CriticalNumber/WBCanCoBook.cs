...
{
	public class WBCanCoBook : IWBCanCoBook
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoBook(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanCoBookSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
