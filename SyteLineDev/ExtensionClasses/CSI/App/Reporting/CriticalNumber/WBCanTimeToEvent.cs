...
//CLASS NAME: WBCanTimeToEvent.cs
...
{
	public class WBCanTimeToEvent : IWBCanTimeToEvent
	{
		readonly IApplicationDB appDB;
		
		public WBCanTimeToEvent(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanTimeToEventSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanTimeToEventSp";
