...
//CLASS NAME: WBCanTimeAndAttendanceExceptions.cs
...
{
	public class WBCanTimeAndAttendanceExceptions : IWBCanTimeAndAttendanceExceptions
	{
		readonly IApplicationDB appDB;
		
		public WBCanTimeAndAttendanceExceptions(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanTimeAndAttendanceExceptionsSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanTimeAndAttendanceExceptionsSp";
