...
//CLASS NAME: WBCanInvValLocDtl.cs
...
{
	public class WBCanInvValLocDtl : IWBCanInvValLocDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvValLocDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInvValLocDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvValLocDtlSp";
