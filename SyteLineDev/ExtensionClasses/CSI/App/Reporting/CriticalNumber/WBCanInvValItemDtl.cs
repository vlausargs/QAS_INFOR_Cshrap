...
//CLASS NAME: WBCanInvValItemDtl.cs
...
{
	public class WBCanInvValItemDtl : IWBCanInvValItemDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvValItemDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInvValItemDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvValItemDtlSp";
