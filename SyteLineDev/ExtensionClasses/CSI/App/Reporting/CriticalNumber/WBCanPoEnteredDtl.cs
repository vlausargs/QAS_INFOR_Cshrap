...
//CLASS NAME: WBCanPoEnteredDtl.cs
...
{
	public class WBCanPoEnteredDtl : IWBCanPoEnteredDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoEnteredDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanPoEnteredDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoEnteredDtlSp";
