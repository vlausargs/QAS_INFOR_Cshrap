...
//CLASS NAME: WBCanInvValCycCnt.cs
...
{
	public class WBCanInvValCycCnt : IWBCanInvValCycCnt
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvValCycCnt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanInvValCycCntSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvValCycCntSp";
