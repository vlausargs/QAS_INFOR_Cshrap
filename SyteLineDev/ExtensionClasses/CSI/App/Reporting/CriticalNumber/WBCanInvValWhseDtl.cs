...
//CLASS NAME: WBCanInvValWhseDtl.cs
...
{
	public class WBCanInvValWhseDtl : IWBCanInvValWhseDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanInvValWhseDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanInvValWhseDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanInvValWhseDtlSp";
