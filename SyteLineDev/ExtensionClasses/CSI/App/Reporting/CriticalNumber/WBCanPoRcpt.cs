...
{
	public class WBCanPoRcpt : IWBCanPoRcpt
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoRcpt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanPoRcptSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
