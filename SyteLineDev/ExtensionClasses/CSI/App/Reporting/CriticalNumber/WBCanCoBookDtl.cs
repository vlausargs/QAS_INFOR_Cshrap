...
{
	public class WBCanCoBookDtl : IWBCanCoBookDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoBookDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanCoBookDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoBookDtlSp";
