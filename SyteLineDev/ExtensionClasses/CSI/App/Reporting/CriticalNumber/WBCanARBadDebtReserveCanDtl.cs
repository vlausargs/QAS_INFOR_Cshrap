...
//CLASS NAME: WBCanARBadDebtReserveCanDtl.cs
...
{
	public class WBCanARBadDebtReserveCanDtl : IWBCanARBadDebtReserveCanDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanARBadDebtReserveCanDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanARBadDebtReserveCanDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanARBadDebtReserveCanDtlSp";
