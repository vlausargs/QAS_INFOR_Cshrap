...
{
	public class WBCanCoEntered : IWBCanCoEntered
	{
		readonly IApplicationDB appDB;
		
		public WBCanCoEntered(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode,
			decimal? Amount) WBCanCoEnteredSp(
			int? KPINum,
			DateTime? AsOfDate,
			decimal? Amount,
			string Parm1 = null,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanCoEnteredSp";
