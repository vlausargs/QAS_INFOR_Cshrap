...
//CLASS NAME: WBCanPoitemPastDueDtl.cs
...
{
	public class WBCanPoitemPastDueDtl : IWBCanPoitemPastDueDtl
	{
		readonly IApplicationDB appDB;
		
		public WBCanPoitemPastDueDtl(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int? WBCanPoitemPastDueDtlSp(
			DateTime? AsOfDate,
			int? DrillNum,
			int? KPINum,
			string Id,
			...
			string Parm50 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "WBCanPoitemPastDueDtlSp";
