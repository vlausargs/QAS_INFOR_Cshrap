...
//CLASS NAME: Rpt_GeneralLedgerTransactionS01DNReport.cs
...
{
	public class Rpt_GeneralLedgerTransactionS01DNReport : IRpt_GeneralLedgerTransactionS01DNReport
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_GeneralLedgerTransactionS01DNReport(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_GeneralLedgerTransactionS01DNReportSp(decimal? ExOptStartingTrans = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_GeneralLedgerTransactionS01DNReportSp";
