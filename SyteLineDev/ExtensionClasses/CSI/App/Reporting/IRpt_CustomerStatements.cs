...
//CLASS NAME: IRpt_CustomerStatements.cs
...
{
	public interface IRpt_CustomerStatements
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_CustomerStatementsSp(DateTime? StatementDate = null,
		int? ShowActive = null,
