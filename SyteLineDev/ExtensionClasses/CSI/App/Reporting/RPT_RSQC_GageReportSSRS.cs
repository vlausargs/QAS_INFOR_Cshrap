...
//CLASS NAME: RPT_RSQC_GageReportSSRS.cs
...
{
	public class RPT_RSQC_GageReportSSRS : IRPT_RSQC_GageReportSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public RPT_RSQC_GageReportSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) RPT_RSQC_GageReportSSRSSp(string BegGage = null,
		string EndGage = null,
		string BegStat = null,
		string EndStat = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "RPT_RSQC_GageReportSSRSSp";
