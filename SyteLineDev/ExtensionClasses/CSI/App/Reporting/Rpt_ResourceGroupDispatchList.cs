...
//CLASS NAME: Rpt_ResourceGroupDispatchList.cs
...
{
	public class Rpt_ResourceGroupDispatchList : IRpt_ResourceGroupDispatchList
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_ResourceGroupDispatchList(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_ResourceGroupDispatchListSp(string ResourceGroupType = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_ResourceGroupDispatchListSp";
