...
//CLASS NAME: Rpt_RSQC_CustAvailToShipSSRS.cs
...
{
	public class Rpt_RSQC_CustAvailToShipSSRS : IRpt_RSQC_CustAvailToShipSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_CustAvailToShipSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_CustAvailToShipSSRSSp(DateTime? CutoffDate = null,
		string BegCust = null,
		string EndCust = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_CustAvailToShipSSRSSp";
