...
//CLASS NAME: Rpt_POFundsCommittedSub.cs
...
{
	public class Rpt_POFundsCommittedSub : IRpt_POFundsCommittedSub
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_POFundsCommittedSub(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_POFundsCommittedSubSp(
			string pPoType = null,
			...
			int? TaskId = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_POFundsCommittedSubSp";
