...
//CLASS NAME: Rpt_GeneralLedgerbyAccount.cs
...
{
	public interface IRpt_GeneralLedgerbyAccount
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_GeneralLedgerbyAccountSp(DateTime? SPerDate = null,
		DateTime? EPerDate = null,
		byte? ShowAllTrx = null,
		string SortByTrx = null,
		string SecondSortBy = null,
		byte? ShowDetail = null,
		byte? AnalyticalLedger = null,
		string ChartType = null,
		string SAcct = null,
		string EAcct = null,
		string SiteGroup = null,
		short? SPerDateOffset = null,
		short? EPerDateOffset = null,
	...
	public class Rpt_GeneralLedgerbyAccount : IRpt_GeneralLedgerbyAccount
	{
		IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
		IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_GeneralLedgerbyAccount(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_GeneralLedgerbyAccountSp(DateTime? SPerDate = null,
		DateTime? EPerDate = null,
		byte? ShowAllTrx = null,
		string SortByTrx = null,
		string SecondSortBy = null,
		...
		string FourthUnitSort = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_GeneralLedgerbyAccountSp";
