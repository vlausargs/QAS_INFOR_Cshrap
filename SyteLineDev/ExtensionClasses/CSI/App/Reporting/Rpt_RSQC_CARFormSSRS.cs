...
//CLASS NAME: Rpt_RSQC_CARFormSSRS.cs
...
{
	public class Rpt_RSQC_CARFormSSRS : IRpt_RSQC_CARFormSSRS
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_CARFormSSRS(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_CARFormSSRSSp(string begcar = null,
		string endcar = null,
		string begitem = null,
		string enditem = null,
		...
		string psite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_CARFormSSRSSp";
