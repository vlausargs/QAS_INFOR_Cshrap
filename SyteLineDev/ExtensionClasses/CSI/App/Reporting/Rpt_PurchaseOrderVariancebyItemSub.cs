...
//CLASS NAME: Rpt_PurchaseOrderVariancebyItemSub.cs
...
{
	public class Rpt_PurchaseOrderVariancebyItemSub : IRpt_PurchaseOrderVariancebyItemSub
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_PurchaseOrderVariancebyItemSub(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
			...
			string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_PurchaseOrderVariancebyItemSubSp";
