...
//CLASS NAME: Rpt_RSQC_CustFinalInspectionWorksheet.cs
...
{
	public class Rpt_RSQC_CustFinalInspectionWorksheet : IRpt_RSQC_CustFinalInspectionWorksheet
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_CustFinalInspectionWorksheet(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_CustFinalInspectionWorksheetSp(
			string BegCust = null,
			string EndCust = null,
			string BegItem = null,
			string EndItem = null,
			...
			int? PrintExternal = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_CustFinalInspectionWorksheetSp";
