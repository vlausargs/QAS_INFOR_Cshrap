...
//CLASS NAME: Rpt_RSQC_TestResults.cs
...
{
	public class Rpt_RSQC_TestResults : IRpt_RSQC_TestResults
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_RSQC_TestResults(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_RSQC_TestResultsSp(
			string begitem = null,
			string enditem = null,
			...
			int? firstarticle = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_RSQC_TestResultsSp";
