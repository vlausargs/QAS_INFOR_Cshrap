...
//CLASS NAME: Rpt_SupplyUsageMrpAps.cs
...
{
	public class Rpt_SupplyUsageMrpAps : IRpt_SupplyUsageMrpAps
	{
        readonly IApplicationDB appDB;
        readonly IBunchedLoadCollection bunchedLoadCollection;
        readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public Rpt_SupplyUsageMrpAps(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) Rpt_SupplyUsageMrpApsSp(string PlannerCodeStarting = null,
		...
		string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "Rpt_SupplyUsageMrpApsSp";
