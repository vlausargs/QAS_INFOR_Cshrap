...
//CLASS NAME: IRpt_AccountBalances.cs
...
{
	public interface IRpt_AccountBalances
	{
		(ICollectionLoadResponse Data, int? ReturnCode) Rpt_AccountBalancesSp(DateTime? ExOptacAsOfDate = null,
