...
{
	public interface IHrSick
	{
		(int? ReturnCode, string Infobar) HrSickSp(string StartingEmpNum = null,
		string EndingEmpNum = null,
		string Infobar = null);
	}
	
	public class HrSick : IHrSick
	{
		readonly IApplicationDB appDB;
		
		public HrSick(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) HrSickSp(string StartingEmpNum = null,
		string EndingEmpNum = null,
		string Infobar = null)
		{
