...
namespace CSI.Codes
{
	public interface IGetARAgeDays
	{
		int GetARAgeDaysSP(ref short? AgeDays1,
		                   ref string AgeDesc1,
		                   ref short? AgeDays2,
		                   ref string AgeDesc2,
		                   ref short? AgeDays3,
	...
	public class GetARAgeDays : IGetARAgeDays
	{
		readonly IApplicationDB appDB;
		
		public GetARAgeDays(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int GetARAgeDaysSP(ref short? AgeDays1,
		                          ref string AgeDesc1,
		                          ref short? AgeDays2,
		                          ref string AgeDesc2,
		                          ref short? AgeDays3,
		                          ...
		                          ref string AgeDesc5)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "GetARAgeDaysSP";
