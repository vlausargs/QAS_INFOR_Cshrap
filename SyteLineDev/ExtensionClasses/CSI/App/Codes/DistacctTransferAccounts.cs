//PROJECT NAME: Codes
//CLASS NAME: DistacctTransferAccounts.cs
...
namespace CSI.Codes
{
	public class DistacctTransferAccounts : IDistacctTransferAccounts
	{
		readonly IApplicationDB appDB;
		
		
		public DistacctTransferAccounts(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DistacctTransferAccountsSp(Guid? DistacctRowPointer,
		int? TransferInv,
		int? TransferLbr,
		int? TransferFovhd,
		int? TransferVovhd,
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DistacctTransferAccountsSp";
