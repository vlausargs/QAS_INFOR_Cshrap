//PROJECT NAME: Config
//CLASS NAME: CfgReSetConfigId.cs
...
{
	public class CfgReSetConfigId : ICfgReSetConfigId
	{
		readonly IApplicationDB appDB;
		
		
		public CfgReSetConfigId(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string ConfigGid) CfgReSetConfigIdSp(string ConfigEntryPoint,
		string Key1,
		string Key2,
		string Key3,
		string ConfigId,
		...
		int? IsDocId = 0)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CfgReSetConfigIdSp";
