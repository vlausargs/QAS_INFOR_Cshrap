...
{
	public class DcjmSerialSave : IDcjmSerialSave
	{
		readonly IApplicationDB appDB;
		
		
		public DcjmSerialSave(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcjmSerialSaveSp(int? TransNum,
		string SerNum,
		int? DerSelect,
		Guid? RowPointer,
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DcjmSerialSaveSp";
