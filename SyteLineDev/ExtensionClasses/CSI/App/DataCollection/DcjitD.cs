...
{
	public interface IDcjitD
	{
		(int? ReturnCode, string Infobar) DcjitDSp(string Status,
	...
	public class DcjitD : IDcjitD
	{
		readonly IApplicationDB appDB;
		
		public DcjitD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcjitDSp(string Status,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
		DateTime? ToTransDate,
