...
{
	public class DcAMiscir : IDcAMiscir
	{
		readonly IApplicationDB appDB;
		
		
		public DcAMiscir(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcAMiscirSp(string TTermId,
		string pTransType,
		string pEmpNum,
		DateTime? TTransDate,
		string pItem,
