...
{
	public interface IDcmatlD
	{
		(int? ReturnCode, string Infobar) DcmatlDSp(string Status,
		string TransType,
	...
	public class DcmatlD : IDcmatlD
	{
		readonly IApplicationDB appDB;
		
		public DcmatlD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcmatlDSp(string Status,
		string TransType,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
