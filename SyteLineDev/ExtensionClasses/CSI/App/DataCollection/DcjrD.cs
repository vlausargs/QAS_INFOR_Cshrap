...
{
	public interface IDcjrD
	{
		(int? ReturnCode, string Infobar) DcjrDSp(string Status,
	...
	public class DcjrD : IDcjrD
	{
		readonly IApplicationDB appDB;
		
		public DcjrD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcjrDSp(string Status,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
		DateTime? ToTransDate,
