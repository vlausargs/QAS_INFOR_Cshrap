...
{
	public interface IDcmoveD
	{
		(int? ReturnCode, string Infobar) DcmoveDSp(string Status,
	...
	public class DcmoveD : IDcmoveD
	{
		readonly IApplicationDB appDB;
		
		public DcmoveD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcmoveDSp(string Status,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
		DateTime? ToTransDate,
