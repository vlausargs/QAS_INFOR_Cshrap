...
//CLASS NAME: DcmatlSerialLoad.cs
...
{
	public class DcmatlSerialLoad : IDcmatlSerialLoad
	{
		readonly IApplicationDB appDB;
		readonly IBunchedLoadCollection bunchedLoadCollection;
		readonly IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse;
		
		public DcmatlSerialLoad(IApplicationDB appDB, IBunchedLoadCollection bunchedLoadCollection, IDataTableToCollectionLoadResponse dataTableToCollectionLoadResponse)
		{
			this.appDB = appDB;
		...
		public (ICollectionLoadResponse Data, int? ReturnCode) DcmatlSerialLoadSp(int? GenSer,
		string TransType,
		decimal? GenQty,
		string SerialPrefix,
		string SerialLike,
		...
		string Site = null)
		{
			...
			try
			{
				...
				using (IDbCommand cmd = appDB.CreateCommand())
				{
					...
					cmd.CommandText = "DcmatlSerialLoadSp";
