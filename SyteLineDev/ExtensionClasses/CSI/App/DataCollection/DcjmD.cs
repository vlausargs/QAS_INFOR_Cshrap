...
{
	public interface IDcjmD
	{
		(int? ReturnCode, string Infobar) DcjmDSp(string Status,
		string TransType,
	...
	public class DcjmD : IDcjmD
	{
		readonly IApplicationDB appDB;
		
		public DcjmD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcjmDSp(string Status,
		string TransType,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
