...
{
	public class DcATimeatI : IDcATimeatI
	{
		readonly IApplicationDB appDB;
		
		
		public DcATimeatI(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcATimeatISp(string TTermId,
		int? TTransType,
		string TEmpNum,
		DateTime? TDate,
		int? TTime,
