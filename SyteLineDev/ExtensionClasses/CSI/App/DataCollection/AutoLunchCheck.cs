...
{
	public class AutoLunchCheck : IAutoLunchCheck
	{
		readonly IApplicationDB appDB;
		
		
		public AutoLunchCheck(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string PError) AutoLunchCheckSp(string PEmpNum,
		string PShift,
		DateTime? PTransDate,
		int? PTransTime,
		string PTransType,
		...
		string PError)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "AutoLunchCheckSp";
