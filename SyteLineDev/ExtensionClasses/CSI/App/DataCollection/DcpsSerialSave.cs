...
{
	public class DcpsSerialSave : IDcpsSerialSave
	{
		readonly IApplicationDB appDB;
		
		
		public DcpsSerialSave(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcpsSerialSaveSp(int? TransNum,
		string SerNum,
		int? DerSelect,
		Guid? RowPointer,
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DcpsSerialSaveSp";
