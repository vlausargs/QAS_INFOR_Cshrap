...
//CLASS NAME: DcmoveSerialSave.cs
...
{
	public class DcmoveSerialSave : IDcmoveSerialSave
	{
		readonly IApplicationDB appDB;
		
		
		public DcmoveSerialSave(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcmoveSerialSaveSp(int? TransNum,
		string SerNum,
		int? DerSelect,
		Guid? RowPointer,
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DcmoveSerialSaveSp";
