...
//CLASS NAME: DcCoValidateEmpNum.cs
...
{
	public class DcCoValidateEmpNum : IDcCoValidateEmpNum
	{
		readonly IApplicationDB appDB;
		
		
		public DcCoValidateEmpNum(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DcCoValidateEmpNumSp";
