...
{
	public interface IDcpoD
	{
		(int? ReturnCode, string Infobar) DcpoDSp(string Status,
		string TransType,
	...
	public class DcpoD : IDcpoD
	{
		readonly IApplicationDB appDB;
		
		public DcpoD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcpoDSp(string Status,
		string TransType,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
