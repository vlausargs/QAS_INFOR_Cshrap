...
{
	public interface IDcpsD
	{
		(int? ReturnCode, string Infobar) DcpsDSp(string Status,
		string TransType,
	...
	public class DcpsD : IDcpsD
	{
		readonly IApplicationDB appDB;
		
		public DcpsD(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcpsDSp(string Status,
		string TransType,
		decimal? FromTransNum,
		decimal? ToTransNum,
		DateTime? FromTransDate,
