...
//CLASS NAME: DcmatlSerialSave.cs
...
{
	public class DcmatlSerialSave : IDcmatlSerialSave
	{
		readonly IApplicationDB appDB;
		
		
		public DcmatlSerialSave(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) DcmatlSerialSaveSp(int? TransNum,
		string SerNum,
		int? DerSelect,
		Guid? RowPointer,
		string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "DcmatlSerialSaveSp";
