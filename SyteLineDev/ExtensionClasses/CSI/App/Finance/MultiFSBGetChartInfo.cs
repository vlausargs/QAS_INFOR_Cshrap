...
//CLASS NAME: MultiFSBGetChartInfo.cs
...
{
	public interface IMultiFSBGetChartInfo
	{
		(int? ReturnCode, string rChartType, string rAccessUnit1, string rAccessUnit2, string rAccessUnit3, string rAccessUnit4, string rDescription, string Infobar) MultiFSBGetChartInfoSp(string pFSBName,
		string pChartAcct,
		string rChartType,
		string rAccessUnit1,
		string rAccessUnit2,
	...
	public class MultiFSBGetChartInfo : IMultiFSBGetChartInfo
	{
		readonly IApplicationDB appDB;
		
		public MultiFSBGetChartInfo(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string rChartType, string rAccessUnit1, string rAccessUnit2, string rAccessUnit3, string rAccessUnit4, string rDescription, string Infobar) MultiFSBGetChartInfoSp(string pFSBName,
		string pChartAcct,
		string rChartType,
		string rAccessUnit1,
		string rAccessUnit2,
		...
		string Site = null)
		{
			FSBNameType _pFSBName = pFSBName;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "MultiFSBGetChartInfoSp";
				
				appDB.AddCommandParameter(cmd, "pFSBName", _pFSBName, ParameterDirection.Input);
				...
				return (Severity, rChartType, rAccessUnit1, rAccessUnit2, rAccessUnit3, rAccessUnit4, rDescription, Infobar);
			}
		}
	}
}
