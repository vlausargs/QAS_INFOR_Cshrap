...
//CLASS NAME: ArpmtLeavePayExchRateAmt.cs
...
{
    public interface IArpmtLeavePayExchRateAmt
    {
        int ArpmtLeavePayExchRateAmtSp(CurrCodeType PFromCurrCode,
    ...
    public class ArpmtLeavePayExchRateAmt : IArpmtLeavePayExchRateAmt
    {
        readonly IApplicationDB appDB;

        public ArpmtLeavePayExchRateAmt(IApplicationDB appDB)
        {
            this.appDB = appDB;
        }

        public int ArpmtLeavePayExchRateAmtSp(CurrCodeType PFromCurrCode,
                                              CurrCodeType PToCurrCode,
                                              CurrCodeType DomCurrCode,
                                              ref AmountType PToCheckAmt,
                                              DateType PRecptDate,
                                              ...
                                              ref InfobarType Infobar)
        {
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "ArpmtLeavePayExchRateAmtSp";
