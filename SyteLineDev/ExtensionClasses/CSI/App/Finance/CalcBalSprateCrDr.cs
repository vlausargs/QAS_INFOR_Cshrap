...
//CLASS NAME: CalcBalSprateCrDr.cs
...
{
	public class CalcBalSprateCrDr : ICalcBalSprateCrDr
	{
		readonly IApplicationDB appDB;
		
		public CalcBalSprateCrDr(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			DateTime? LastPeriodPerEnd = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CalcBalSprateCrDrSp";
