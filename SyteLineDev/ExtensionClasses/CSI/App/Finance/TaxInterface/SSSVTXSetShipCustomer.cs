...
//CLASS NAME: SSSVTXSetShipCustomer.cs
...
{
	public class SSSVTXSetShipCustomer : ISSSVTXSetShipCustomer
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXSetShipCustomer(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXSetShipCustomerSp";
