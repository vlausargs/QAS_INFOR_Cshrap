...
//CLASS NAME: SSSVTXSetShipProspect.cs
...
{
	public class SSSVTXSetShipProspect : ISSSVTXSetShipProspect
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXSetShipProspect(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string Infobar)
		{
			ProspectIDType _iProspectId = iProspectId;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXSetShipProspectSp";
				
				appDB.AddCommandParameter(cmd, "iProspectId", _iProspectId, ParameterDirection.Input);
