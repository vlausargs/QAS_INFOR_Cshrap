...
//CLASS NAME: SSSVTXFSPGetHeaderInfo.cs
...
{
	public class SSSVTXFSPGetHeaderInfo : ISSSVTXFSPGetHeaderInfo
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXFSPGetHeaderInfo(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string LocationCode)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXFSPGetHeaderInfoSp";
