...
//CLASS NAME: SSSVTXFSPGetLineInfo.cs
...
{
	public class SSSVTXFSPGetLineInfo : ISSSVTXFSPGetLineInfo
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXFSPGetLineInfo(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string Infobar,
			string LocationCode) SSSVTXFSPGetLineInfoSp(
			string pRefType,
			Guid? pHdrPtr,
			string pLineRefType,
			Guid? pLinePtr,
			...
			string LocationCode)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXFSPGetLineInfoSp";
