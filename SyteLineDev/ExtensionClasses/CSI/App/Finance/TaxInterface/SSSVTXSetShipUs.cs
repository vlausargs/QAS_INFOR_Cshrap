...
{
	public class SSSVTXSetShipUs : ISSSVTXSetShipUs
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXSetShipUs(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXSetShipUsSp";
