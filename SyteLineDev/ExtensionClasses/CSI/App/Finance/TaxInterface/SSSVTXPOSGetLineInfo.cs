...
//CLASS NAME: SSSVTXPOSGetLineInfo.cs
...
{
	public class SSSVTXPOSGetLineInfo : ISSSVTXPOSGetLineInfo
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXPOSGetLineInfo(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string LocationCode)
		{
			...
			GenericDateType _oTaxDate = oTaxDate;
			TaxModeType _oTaxCreditFlag = oTaxCreditFlag;
			UMType _oUM = oUM;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXPOSGetLineInfoSp";
