...
//CLASS NAME: SSSVTXFSPGetKeys.cs
...
{
	public class SSSVTXFSPGetKeys : ISSSVTXFSPGetKeys
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXFSPGetKeys(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXFSPGetKeysSp";
