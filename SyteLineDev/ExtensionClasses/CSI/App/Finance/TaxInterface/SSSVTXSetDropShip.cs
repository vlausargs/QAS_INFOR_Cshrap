...
//CLASS NAME: SSSVTXSetDropShip.cs
...
{
	public class SSSVTXSetDropShip : ISSSVTXSetDropShip
	{
		readonly IApplicationDB appDB;
		
		public SSSVTXSetDropShip(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSVTXSetDropShipSp";
