...
namespace CSI.Finance
{
    ...
    public class Budroll : IBudroll
    {
        readonly IApplicationDB appDB;

        public Budroll(IApplicationDB appDB)
        {
            this.appDB = appDB;
        }

        public int BudrollSp(ChartTypeType pAssetChart,
                             ChartTypeType pLiabilityChart,
                             ChartTypeType pOwnersEquityChart,
                             ChartTypeType pRevenueChart,
                             ChartTypeType pExpenseChart,
                             ...
                             ref InfobarType rInfobar)
        {
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                appDB.AddCommandParameter(cmd, "pAnalyticalChart", pAnalyticalChart, ParameterDirection.Input);
