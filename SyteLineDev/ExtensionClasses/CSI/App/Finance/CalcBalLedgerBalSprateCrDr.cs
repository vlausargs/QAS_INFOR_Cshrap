...
//CLASS NAME: CalcBalLedgerBalSprateCrDr.cs
...
{
	public class CalcBalLedgerBalSprateCrDr : ICalcBalLedgerBalSprateCrDr
	{
		readonly IApplicationDB appDB;
		
		public CalcBalLedgerBalSprateCrDr(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		public (int? ReturnCode,
			...
			string pSite = null)
		{
			ListYesNoType _TAnalytical = TAnalytical;
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CalcBalLedgerBalSprateCrDrSp";
				
				appDB.AddCommandParameter(cmd, "TAnalytical", _TAnalytical, ParameterDirection.Input);
