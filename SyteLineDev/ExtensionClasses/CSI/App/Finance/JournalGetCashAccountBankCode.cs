...
//CLASS NAME: JournalGetCashAccountBankCode.cs
...
{
	public class JournalGetCashAccountBankCode : IJournalGetCashAccountBankCode
	{
		readonly IApplicationDB appDB;
		
		
		public JournalGetCashAccountBankCode(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		string AcctUnit4 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "JournalGetCashAccountBankCodeSp";
				...
				return (Severity, PBankCode, PCurrCode);
			}
		}
	}
}
