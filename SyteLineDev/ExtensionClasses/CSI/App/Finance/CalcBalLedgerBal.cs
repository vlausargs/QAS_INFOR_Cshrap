...
//CLASS NAME: CalcBalLedgerBal.cs
...
{
	public class CalcBalLedgerBal : ICalcBalLedgerBal
	{
		readonly IApplicationDB appDB;
		
		public CalcBalLedgerBal(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string pSite = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CalcBalLedgerBalSp";
