...
//CLASS NAME: MultiFSBYearEndClosing.cs
...
{
	public interface IMultiFSBYearEndClosing
	{
		(int? ReturnCode, string Infobar) MultiFSBYearEndClosingSp(string FSBName,
	...
	public class MultiFSBYearEndClosing : IMultiFSBYearEndClosing
	{
		readonly IApplicationDB appDB;
		
		public MultiFSBYearEndClosing(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, string Infobar) MultiFSBYearEndClosingSp(string FSBName,
		string CurId = "General",
		string IncomeSummaryAccount = null,
		string IncomeSummaryAccountUnit1 = null,
		string IncomeSummaryAccountUnit2 = null,
		...
		string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "MultiFSBYearEndClosingSp";
