...
{
	public class ExtFin2CurrCnvt : IExtFin2CurrCnvt
	{
		readonly IApplicationDB appDB;
		
		public ExtFin2CurrCnvt(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			decimal? Result15 = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ExtFin2CurrCnvtSp";
