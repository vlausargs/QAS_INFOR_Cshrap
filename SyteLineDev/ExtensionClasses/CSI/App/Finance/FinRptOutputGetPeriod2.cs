...
//CLASS NAME: FinRptOutputGetPeriod2.cs
...
{
	public class FinRptOutputGetPeriod2 : IFinRptOutputGetPeriod2
	{
		readonly IApplicationDB appDB;
		
		
		public FinRptOutputGetPeriod2(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public (int? ReturnCode, DateTime? PeriodStart,
		DateTime? PeriodEnd,
		...
		string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "FinRptOutputGetPeriod2Sp";
				...
				return (Severity, PeriodStart, PeriodEnd, Infobar);
			}
		}
	}
}
