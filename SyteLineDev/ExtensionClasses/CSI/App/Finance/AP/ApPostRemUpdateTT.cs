...
//CLASS NAME: ApPostRemUpdateTT.cs
...
{
	public class ApPostRemUpdateTT : IApPostRemUpdateTT
	{
		readonly IApplicationDB appDB;
		
		public ApPostRemUpdateTT(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			string Infobar = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "ApPostRemUpdateTTSp";
