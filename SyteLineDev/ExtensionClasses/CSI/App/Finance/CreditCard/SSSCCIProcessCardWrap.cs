...
//CLASS NAME: SSSCCIProcessCardWrap.cs
...
{
	public interface ISSSCCIProcessCardWrap
	{
		(int? ReturnCode, string cardType,
		string authCode,
		decimal? GatewayTransNum,
		string Infobar,
		byte? iSuccess) SSSCCIProcessCardWrapSp(string TransType,
		string cardNum,
		string expDate,
		string NameOnCard,
	...
	public class SSSCCIProcessCardWrap : ISSSCCIProcessCardWrap
	{
		readonly IApplicationDB appDB;
		
		public SSSCCIProcessCardWrap(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		...
		byte[] Signature = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SSSCCIProcessCardWrapSp";
