//PROJECT NAME: CSICCI
//CLASS NAME: CCITotalAmtChanged.cs
...
{
	public interface ICCITotalAmtChanged
	{
		int CCITotalAmtChangedSp(string CustNum,
		                         string CardSystemId,
		                         decimal? TotalAmt,
		                         ref decimal? DomAmt,
		                         ref decimal? ForAmt,
	...
	public class CCITotalAmtChanged : ICCITotalAmtChanged
	{
		readonly IApplicationDB appDB;
		
		public CCITotalAmtChanged(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
		
		public int CCITotalAmtChangedSp(string CustNum,
		                                string CardSystemId,
		                                decimal? TotalAmt,
		                                ref decimal? DomAmt,
		                                ref decimal? ForAmt,
		                                ...
		                                ref string Infobar)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CCITotalAmtChangedSp";
