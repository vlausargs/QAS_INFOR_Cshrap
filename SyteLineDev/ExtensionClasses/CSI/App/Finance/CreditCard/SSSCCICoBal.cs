...
namespace CSI.Finance.CreditCard
{
	public interface ISSSCCICoBal
	{
		...
		decimal? ForAmt,
		int? CustSeq,
		string Infobar) SSSCCICoBalSp(string CoNum,
		decimal? Balance,
		decimal? TaxAmt,
		decimal? ExchRate,
		decimal? ForAmt,
	...
	public class SSSCCICoBal : ISSSCCICoBal
	{
		readonly IApplicationDB appDB;
		
		public SSSCCICoBal(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
