...
//CLASS NAME: CHSGLItemAccount.cs
...
{
	public class CHSGLItemAccount : ICHSGLItemAccount
	{
		readonly IApplicationDB appDB;
		
		public CHSGLItemAccount(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			DateTime? Pedate = null)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CHSGLItemAccountSP";
