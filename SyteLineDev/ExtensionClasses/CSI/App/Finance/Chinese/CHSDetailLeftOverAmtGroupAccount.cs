...
//CLASS NAME: CHSDetailLeftOverAmtGroupAccount.cs
...
{
	public class CHSDetailLeftOverAmtGroupAccount : ICHSDetailLeftOverAmtGroupAccount
	{
		readonly IApplicationDB appDB;
		
		public CHSDetailLeftOverAmtGroupAccount(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}
			...
			DateTime? Pedate)
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "CHSDetailLeftOverAmtGroupAccountSP";
