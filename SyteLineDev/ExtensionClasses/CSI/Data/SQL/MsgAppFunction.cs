...
{
	public class MsgAppFunction : IMsgAppFunction
	{
		IApplicationDB appDB;


		public MsgAppFunction(IApplicationDB appDB)
		{
			this.appDB = appDB;
		}

		public string MsgAppFunctionSp(string Infobar,
		string BaseMsg,
		string Parm1 = "",
		string Parm2 = "",
		string Parm3 = "",
		...
		string Parm15 = "")
		{
			...
			using (IDbCommand cmd = appDB.CreateCommand())
			{
				...
				cmd.CommandText = "SELECT  dbo.[MsgAppFunctionSp](@Infobar, @BaseMsg, @Parm1, @Parm2, @Parm3, @Parm4, @Parm5, @Parm6, @Parm7, @Parm8, @Parm9, @Parm10, @Parm11, @Parm12, @Parm13, @Parm14, @Parm15)";
