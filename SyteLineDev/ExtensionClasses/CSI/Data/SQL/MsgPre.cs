...
{
    public class MsgPre : IMsgPre
    {
        IApplicationDB appDB;


        public MsgPre(IApplicationDB appDB)
        {
            this.appDB = appDB;
        }

        public (int? ReturnCode, string Infobar) MsgPreSp(string Infobar,
        string BaseMsg,
        string Parm1 = "",
        string Parm2 = "",
        string Parm3 = "",
