...
//CLASS NAME: NotifyPublicationSubscribers.cs
...
{
    public class NotifyPublicationSubscribers : INotifyPublicationSubscribers
    {
        IApplicationDB appDB;


        public NotifyPublicationSubscribers(IApplicationDB appDB)
        {
            this.appDB = appDB;
        }

        public (int? ReturnCode, string Infobar) NotifyPublicationSubscribersSp(string PublicationName = null,
        ...
        string Category = null)
        {
            ...
            using (IDbCommand cmd = appDB.CreateCommand())
            {
                ...
                cmd.CommandText = "NotifyPublicationSubscribersSp";
