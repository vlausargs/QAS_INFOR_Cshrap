    ...
    Public Class OAuthManager
        ...
        Private Function GenerateNonce() As String
            ...
            For i As Integer = 0 To 7
                Dim g As Integer = _random.[Next](3) + 97
                Select Case g
                    Case 0
                        ' lowercase alpha
                        sb.Append(CChar(ChrW(_random.[Next](26) + 97)), 1)
                        Exit Select
                    Case Else
                        ' numeric digits
                        sb.Append(CChar(ChrW(_random.[Next](10) + 48)), 1)
                        Exit Select
                End Select
            Next
            Return sb.ToString()
...
#If BROKEN Then
		...
		End Function
#End If
        Private Shared ReadOnly _epoch As New DateTime(1970, 1, 1, 0, 0, 0, _
            0)
